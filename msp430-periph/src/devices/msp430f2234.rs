...
utils::device! {
    /// MSP430F2234
    #[all:cfg_attr(not(feature = "MSP430F2234-all"), non_exhaustive)]
    MSP430F2234;
    /// Special Function
    ...
    #[all:cfg(feature = "operational_amplifier_2")]
    Operational_Amplifier @ 0x00c0: operational_amplifier_2::OperationalAmplifier;
    /// Timer B3
