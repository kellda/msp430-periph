...
utils::device! {
    /// MSP430FR2512
    #[all:cfg_attr(not(feature = "MSP430FR2512-all"), non_exhaustive)]
    MSP430FR2512;
    /// SFR
    ...
    /// TA0
    #[all:cfg(feature = "ta0_3560_inst7")]
    TA0 @ 0x0380: ta0_3560_inst7::TA0;
    /// TA1
    #[all:cfg(feature = "ta1_3560_inst7")]
    ...
    /// CAPTIVATE
    #[all:cfg(feature = "captivate_445_inst4")]
