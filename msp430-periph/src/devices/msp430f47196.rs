...
utils::device! {
    /// MSP430F47196
    #[all:cfg_attr(not(feature = "MSP430F47196-all"), non_exhaustive)]
    MSP430F47196;
    /// Special Function
