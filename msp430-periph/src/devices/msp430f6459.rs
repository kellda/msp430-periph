...
utils::device! {
    /// MSP430F6459
    #[all:cfg_attr(not(feature = "msp430f6459-all"), non_exhaustive)]
    MSP430F6459;
    ...
    /// DMA
    #[all:cfg(feature = "dma_13")]
    DMA @ 0x0500: dma_13::DMA;
    /// USCI_A0  UART Mode
...
#[repr(u16)]
pub enum Interrupt {
    /// 0xFFC6 USCI B2 Receive/Transmit
    USCI_B2 = 35,
    /// 0xFFC8 USCI A2 Receive/Transmit
    USCI_A2 = 36,
    /// 0xFFCA Port 4
    PORT4 = 37,
    /// 0xFFCC Port 3
    ...
    /// 0xFFE4 DMA
    DMA = 50,
    /// 0xFFE6 LDO Power Management event
    LDO_PWR = 51,
