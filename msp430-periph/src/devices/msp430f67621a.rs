...
utils::device! {
    /// MSP430F67621A
    #[all:cfg_attr(not(feature = "MSP430F67621A-all"), non_exhaustive)]
    MSP430F67621A;
    ...
    #[all:cfg(feature = "rtc_c__real_time_clock_2")]
    RTC_C__Real_Time_Clock @ 0x04a0: rtc_c__real_time_clock_2::RTC_CRealTimeClock;
    ...
    /// SD24_B3
    #[all:cfg(feature = "sd24_b3_2")]
    SD24_B3 @ 0x0800: sd24_b3_2::SD24_B3;
    /// Auxilary Supply
