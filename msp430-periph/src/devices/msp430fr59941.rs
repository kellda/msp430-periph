...
utils::device! {
    /// MSP430FR59941
    #[all:cfg_attr(not(feature = "MSP430FR59941-all"), non_exhaustive)]
    MSP430FR59941;
    /// SFR
    ...
    /// RAMCTL
    #[all:cfg(feature = "ramctl_3670_config1")]
    RAMCTL @ 0x0158: ramctl_3670_config1::RAMCTL;
    /// WDT_A
    ...
    /// eUSCI_B2
    #[all:cfg(feature = "eusci_b2_2080")]
    eUSCI_B2 @ 0x06c0: eusci_b2_2080::eUSCI_B2;
    /// eUSCI_B3
    #[all:cfg(feature = "eusci_b3_2080")]
    eUSCI_B3 @ 0x0700: eusci_b3_2080::eUSCI_B3;
    /// TA4
    #[all:cfg(feature = "ta4_3560_inst3")]
    TA4 @ 0x07c0: ta4_3560_inst3::TA4;
    /// ADC12_B
