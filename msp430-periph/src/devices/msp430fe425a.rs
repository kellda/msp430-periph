...
utils::device! {
    /// MSP430FE425A
    #[all:cfg_attr(not(feature = "msp430fe425a-all"), non_exhaustive)]
    MSP430FE425A;
    /// Special Function
    ...
    /// ESPCTL
    #[all:cfg(feature = "espctl_2")]
    ESPCTL @ 0x0150: espctl_2::ESPCTLPeriph;
}
