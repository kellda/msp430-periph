...
utils::device! {
    /// MSP430F2491
    #[all:cfg_attr(not(feature = "msp430f2491-all"), non_exhaustive)]
    MSP430F2491;
    /// Special Function
    ...
    #[all:cfg(feature = "tlv_calibration_data_3")]
    TLV_Calibration_Data @ 0x10c0: tlv_calibration_data_3::TLVCalibrationData;
    /// Calibration Data
...
pub enum Interrupt {
    ...
    RESERVED13 = 13,
    /// 0xFFDC Reserved Int. Vector 14
    RESERVED14 = 14,
    /// 0xFFDE Reserved Int. Vector 15
    RESERVED15 = 15,
