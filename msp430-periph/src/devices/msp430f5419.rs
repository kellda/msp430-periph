...
utils::device! {
    /// MSP430F5419
    #[all:cfg_attr(not(feature = "msp430f5419-all"), non_exhaustive)]
    MSP430F5419;
    ...
    /// SYS  System Module
    #[all:cfg(feature = "sys_1")]
    SYS @ 0x0180: sys_1::SYS;
    /// Port A
...
pub enum Interrupt {
    ...
    /// 0xFFD4 Port 2
    PORT2 = 42,
    /// 0xFFD6 USCI B3 Receive/Transmit
    USCI_B3 = 43,
    /// 0xFFD8 USCI A3 Receive/Transmit
    USCI_A3 = 44,
    ...
    /// 0xFFE4 DMA
    DMA = 50,
    /// 0xFFE6 USCI B2 Receive/Transmit
    USCI_B2 = 51,
    /// 0xFFE8 USCI A2 Receive/Transmit
    USCI_A2 = 52,
    /// 0xFFEA Timer0_A5 CC1-4, TA
    TIMER0_A1 = 53,
    /// 0xFFEC Timer0_A5 CC0
    TIMER0_A0 = 54,
    /// 0xFFEE ADC
    ADC12 = 55,
    ...
    WDT = 58,
    /// 0xFFF6 Timer0_B7 CC1-6, TB
    TIMER0_B1 = 59,
    /// 0xFFF8 Timer0_B7 CC0
    TIMER0_B0 = 60,
