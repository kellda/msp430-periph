...
utils::device! {
    /// MSP430FR69891
    #[all:cfg_attr(not(feature = "msp430fr69891-all"), non_exhaustive)]
    MSP430FR69891;
    ...
    /// ExtScanIF
    #[all:cfg(feature = "extscanif")]
    ExtScanIF @ 0x0d00: extscanif::ExtScanIF;
    /// ExtScanIF_RAM
    #[all:cfg(feature = "extscanif_ram")]
    ExtScanIF_RAM @ 0x0e00: extscanif_ram::ExtScanIF_RAM;
}
...
static __INTERRUPTS: [crate::Vector; 55] = [
    ...
    crate::Vector { _handler: ESCAN_IF },
