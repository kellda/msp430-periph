...
utils::periph! {
    ...
    rw TA4CCTL0 @ 0x02: u16 = 0_0 {
        ...
        TA4CCTL0_CCIFG: 0 = enum TA4CCTL0_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA4CCTL0_COV: 1 = enum TA4CCTL0_COV {
        ...
        /// Output
        TA4CCTL0_OUT: 2 = enum TA4CCTL0_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        TA4CCTL0_CCIE: 4 = enum TA4CCTL0_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA4CCTL0_CAP: 8 = enum TA4CCTL0_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        TA4CCTL0_SCS: 11 = enum TA4CCTL0_SCS {
    ...
    rw TA4CCTL1 @ 0x04: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA4CCTL1_CCIFG: 0 = enum TA4CCTL1_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA4CCTL1_COV: 1 = enum TA4CCTL1_COV {
            /// No capture overflow occurred
            COV_0 = 0b0,
            /// Capture overflow occurred
            COV_1 = 0b1,
        ...
        /// Output
        TA4CCTL1_OUT: 2 = enum TA4CCTL1_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        /// Capture/compare interrupt enable
        TA4CCTL1_CCIE: 4 = enum TA4CCTL1_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA4CCTL1_CAP: 8 = enum TA4CCTL1_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        /// Synchronize capture source
        TA4CCTL1_SCS: 11 = enum TA4CCTL1_SCS {
            /// Asynchronous capture
            ASYNC = 0b0,
            /// Synchronous capture
            SYNC = 0b1,
    ...
    /// Timer_A Capture/Compare Control Register
    rw TA4CCTL2 @ 0x06: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA4CCTL2_CCIFG: 0 = enum TA4CCTL2_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA4CCTL2_COV: 1 = enum TA4CCTL2_COV {
            /// No capture overflow occurred
            COV_0 = 0b0,
            /// Capture overflow occurred
            COV_1 = 0b1,
        ...
        /// Output
        TA4CCTL2_OUT: 2 = enum TA4CCTL2_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        /// Capture/compare input
        TA4CCTL2_CCI: 3 = struct TA4CCTL2_CCI(bool);
        /// Capture/compare interrupt enable
        TA4CCTL2_CCIE: 4 = enum TA4CCTL2_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Output mode
        TA4CCTL2_OUTMOD: 5..7 = enum TA4CCTL2_OUTMOD {
            /// OUT bit value
            OUTMOD_0 = 0b000,
            /// Set
            OUTMOD_1 = 0b001,
        ...
        /// Capture mode
        TA4CCTL2_CAP: 8 = enum TA4CCTL2_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        /// Synchronized capture/compare input
        TA4CCTL2_SCCI: 10 = struct TA4CCTL2_SCCI(bool);
        /// Synchronize capture source
        TA4CCTL2_SCS: 11 = enum TA4CCTL2_SCS {
            /// Asynchronous capture
            ASYNC = 0b0,
            /// Synchronous capture
            SYNC = 0b1,
        ...
        /// Capture/compare input select
        TA4CCTL2_CCIS: 12..13 = enum TA4CCTL2_CCIS {
            /// CCIxA
            CCIA = 0b00,
            /// CCIxB
            CCIB = 0b01,
        ...
        /// Capture mode
        TA4CCTL2_CM: 14..15 = enum TA4CCTL2_CM {
            /// No capture
            NONE = 0b00,
            /// Capture on rising edge
            RISING = 0b01,
    ...
    /// Timer_A Capture/Compare  Register
    rw TA4CCR2 @ 0x16: u16 = 0_0 {
        /// Timer_A Capture/Compare  Register
        TA4CCR2: 0..15 = struct TA4CCR2Field(u16);
    }
