...
utils::periph! {
    ...
    rw TA4CCTL2 @ 0x06: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA4CCTL2_CCIFG: 0..0 = enum TA4CCTL2_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA4CCTL2_COV: 1..1 = enum TA4CCTL2_COV {
            /// No capture overflow occurred
            COV_0 = 0b0,
            /// Capture overflow occurred
            COV_1 = 0b1,
        ...
        /// Output
        TA4CCTL2_OUT: 2..2 = enum TA4CCTL2_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        /// Capture/compare interrupt enable
        TA4CCTL2_CCIE: 4..4 = enum TA4CCTL2_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA4CCTL2_CAP: 8..8 = enum TA4CCTL2_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        /// Synchronize capture source
        TA4CCTL2_SCS: 11..11 = enum TA4CCTL2_SCS {
            /// Asynchronous capture
            ASYNC = 0b0,
            /// Synchronous capture
            SYNC = 0b1,
