...
utils::periph! {
    ...
    rw UCA2CTL0 @ 0x01: u8 = 0_0 {
        /// USCI A2 Control Register 0
        UCA2CTL0: 0..7 = struct UCA2CTL0Field(u8);
    }
    /// USCI A2 Control Register 1
    rw UCA2CTL1 @ 0x00: u8 = 0_0 {
        /// USCI A2 Control Register 1
        UCA2CTL1: 0..7 = struct UCA2CTL1Field(u8);
    }
    /// USCI A2 Control Word Register 1
    ...
    rw UCA2RXBUF @ 0x0c: u16 = 0_0 {
        /// USCI A2 Receive Buffer
        UCA2RXBUF: 0..15 = struct UCA2RXBUFField(u16);
    }
    /// USCI A2 Transmit Buffer
    rw UCA2TXBUF @ 0x0e: u16 = 0_0 {
        /// USCI A2 Transmit Buffer
        UCA2TXBUF: 0..15 = struct UCA2TXBUFField(u16);
    }
    /// USCI A2 LIN Control
    ...
    rw UCA2IRTCTL @ 0x12: u8 = 0_0 {
        /// USCI A2 IrDA Transmit Control
        UCA2IRTCTL: 0..7 = struct UCA2IRTCTLField(u8);
    }
    /// USCI A2 IrDA Receive Control
    rw UCA2IRRCTL @ 0x13: u8 = 0_0 {
        /// USCI A2 IrDA Receive Control
        UCA2IRRCTL: 0..7 = struct UCA2IRRCTLField(u8);
    }
    /// USCI A2 Interrupt Enable Register
    rw UCA2IE @ 0x1a: u16 = 0_0 {
        /// USCI A2 Interrupt Enable Register
        UCA2IE: 0..15 = struct UCA2IEField(u16);
    }
    /// USCI A2 Interrupt Flags Register
    rw UCA2IFG @ 0x1c: u16 = 0_0 {
        /// USCI A2 Interrupt Flags Register
        UCA2IFG: 0..15 = struct UCA2IFGField(u16);
    }
    /// USCI A2 Interrupt Enable Register
    rw UCA2IE__UART @ 0x1a: u16 = 0_0 {
