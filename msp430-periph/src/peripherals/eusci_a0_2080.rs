...
utils::periph! {
    ...
    rw UCA0CTLW0 @ 0x00: u16 = 0_0 {
        ...
        UCA0CTLW0_UCSSEL: 6..7 = enum UCA0CTLW0_UCSSEL {
            /// UCLK
            UCLK = 0b00,
            /// ACLK
            ACLK = 0b01,
        ...
        /// eUSCI_A mode
        UCA0CTLW0_UCMODE: 9..10 = enum UCA0CTLW0_UCMODE {
            /// UART mode
            UCMODE_0 = 0b00,
    ...
    rw UCA0CTLW0_SPI @ 0x00: u16 = 0_0 {
        ...
        /// eUSCI_A clock source select
        UCA0CTLW0_SPI_UCSSEL: 6..7 = enum UCA0CTLW0_SPI_UCSSEL {
            /// Reserved
            UCSSEL_0 = 0b00,
            /// ACLK
            ACLK = 0b01,
        ...
        /// eUSCI mode
        UCA0CTLW0_SPI_UCMODE: 9..10 = enum UCA0CTLW0_SPI_UCMODE {
            /// 3-pin SPI
            UCMODE_0 = 0b00,
    ...
    rw UCA0BRW_SPI @ 0x06: u16 = 0_0 {
        /// eUSCI_Ax Bit Rate Control Register 1
        UCA0BRW_SPI: 0..15 = struct UCA0BRW_SPIField(u16);
    }
    ...
    r UCA0RXBUF @ 0x0c: u16 = 0_0 {
        /// Receive data buffer
        UCA0RXBUF_UCRXBUF: 0..7 = struct UCA0RXBUF_UCRXBUF(u16);
    }
    /// eUSCI_Ax Receive Buffer Register
    r UCA0RXBUF_SPI @ 0x0c: u16 = 0_0 {
        /// Receive data buffer
        UCA0RXBUF_SPI_UCRXBUF: 0..7 = struct UCA0RXBUF_SPI_UCRXBUF(u16);
    }
    /// eUSCI_Ax Transmit Buffer Register
    rw UCA0TXBUF @ 0x0e: u16 = 0_0 {
        /// Transmit data buffer
        UCA0TXBUF_UCTXBUF: 0..7 = struct UCA0TXBUF_UCTXBUF(u16);
    }
    /// eUSCI_Ax Transmit Buffer Register
    rw UCA0TXBUF_SPI @ 0x0e: u16 = 0_0 {
        /// Transmit data buffer
        UCA0TXBUF_SPI_UCTXBUF: 0..7 = struct UCA0TXBUF_SPI_UCTXBUF(u16);
    }
    ...
    r UCA0IV @ 0x1e: u16 = 0_0 {
        /// eUSCI_A interrupt vector value
        UCA0IV_UCIV: 0..15 = enum UCA0IV_UCIV {
            /// No interrupt pending
    ...
    /// eUSCI_Ax Interrupt Vector Register
    r UCA0IV_SPI @ 0x1e: u16 = 0_0 {
        /// eUSCI_A interrupt vector value
        UCA0IV_SPI_UCIV: 0..15 = enum UCA0IV_SPI_UCIV {
            /// No interrupt pending
            NONE = 0b0000000000000000,
