...
utils::periph! {
    ...
    rw UCB1CTLW0 @ 0x00: u16 = 0_0 {
        ...
        UCB1CTLW0_UCSWRST: 0 = enum UCB1CTLW0_UCSWRST {
        ...
        UCB1CTLW0_UCSYNC: 8 = enum UCB1CTLW0_UCSYNC {
            /// Asynchronous mode
            ASYNC = 0b0,
            /// Synchronous mode
            SYNC = 0b1,
        ...
        /// Master mode select
        UCB1CTLW0_UCMST: 11 = enum UCB1CTLW0_UCMST {
            /// Slave mode
            SLAVE = 0b0,
            /// Master mode
            MASTER = 0b1,
    ...
    rw UCB1CTLW0_SPI @ 0x00: u16 = 0_0 {
        /// Software reset enable
        UCB1CTLW0_SPI_UCSWRST: 0 = enum UCB1CTLW0_SPI_UCSWRST {
            /// Disabled. eUSCI_B reset released for operation
            DISABLE = 0b0,
            /// Enabled. eUSCI_B logic held in reset state
            ENABLE = 0b1,
        ...
        /// Synchronous mode enable
        UCB1CTLW0_SPI_UCSYNC: 8 = enum UCB1CTLW0_SPI_UCSYNC {
            /// Asynchronous mode
            ASYNC = 0b0,
            /// Synchronous mode
            SYNC = 0b1,
        ...
        /// Master mode select
        UCB1CTLW0_SPI_UCMST: 11 = enum UCB1CTLW0_SPI_UCMST {
            /// Slave mode
            SLAVE = 0b0,
            /// Master mode
            MASTER = 0b1,
    ...
    rw UCB1I2COA0 @ 0x14: u16 = 0_0 {
        ...
        UCB1I2COA0_UCOAEN: 10 = enum UCB1I2COA0_UCOAEN {
    ...
    rw UCB1I2COA1 @ 0x16: u16 = 0_0 {
        ...
        /// Own Address enable register
        UCB1I2COA1_UCOAEN: 10 = enum UCB1I2COA1_UCOAEN {
    ...
    rw UCB1I2COA2 @ 0x18: u16 = 0_0 {
        ...
        /// Own Address enable register
        UCB1I2COA2_UCOAEN: 10 = enum UCB1I2COA2_UCOAEN {
    ...
    rw UCB1I2COA3 @ 0x1a: u16 = 0_0 {
        ...
        /// Own Address enable register
        UCB1I2COA3_UCOAEN: 10 = enum UCB1I2COA3_UCOAEN {
