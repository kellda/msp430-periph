...
utils::periph! {
    ...
    rw SD24BIFG @ 0x0a: u16 = 0_0 {
        ...
        /// SD24B Channel 6 Interrupt Flag
        SD24IFG6: 6 = struct SD24IFG6(bool);
        ...
        /// SD24B Channel 6 Overflow Interrupt Flag
        SD24OVIFG6: 14 = struct SD24OVIFG6(bool);
    }
    ...
    rw SD24BIE @ 0x0c: u16 = 0_0 {
        ...
        /// SD24B Channel 6 Interrupt Enable
        SD24IE6: 6 = struct SD24IE6(bool);
        ...
        /// SD24B Channel 6 Overflow Interrupt Enable
        SD24OVIE6: 14 = struct SD24OVIE6(bool);
    }
    ...
    /// SD24B Channel 6 Control Register
    rw SD24BCCTL6 @ 0x40: u16 = 0_0 {
        /// SD24B Start Conversion
        SD24BCCTL6_SD24SC: 0 = struct SD24BCCTL6_SD24SC(bool);
        /// SD24B Start Conversion Select Bit 0
        SD24BCCTL6_SD24SCS: 1..3 = enum SD24BCCTL6_SD24SCS {
            /// SD24B Start Conversion Select: 0
            SD24SCS_0 = 0b000,
            /// SD24B Start Conversion Select: 1
            SD24SCS_1 = 0b001,
        ...
        /// SD24B Data Format Bit: 0
        SD24BCCTL6_SD24DF: 4..5 = enum SD24BCCTL6_SD24DF {
            /// SD24B Data Format: Offset Binary
            SD24DF_0 = 0b00,
            /// SD24B Data Format: 2's complement
            SD24DF_1 = 0b01,
        ...
        /// SD24B Data Alignment
        SD24BCCTL6_SD24ALGN: 6 = struct SD24BCCTL6_SD24ALGN(bool);
        /// SD24B Single Trigger Mode
        SD24BCCTL6_SD24SNGL: 8 = struct SD24BCCTL6_SD24SNGL(bool);
        /// SD24B Calibration
        SD24BCCTL6_SD24CAL: 9 = struct SD24BCCTL6_SD24CAL(bool);
        /// SD24B Digital Filter Bit: 0
        SD24BCCTL6_SD24DFS: 10..11 = enum SD24BCCTL6_SD24DFS {
            /// SD24B Digital Filter 0
            SD24DFS_0 = 0b00,
            /// SD24B Digital Filter 1
            SD24DFS_1 = 0b01,
        ...
        /// SD24B Digital Bitstream Input
        SD24BCCTL6_SD24DI: 12 = struct SD24BCCTL6_SD24DI(bool);
        /// SD24B Manchaster Encoding Bit: 0
        SD24BCCTL6_SD24MC: 13..14 = enum SD24BCCTL6_SD24MC {
            /// SD24B Manchaster Encoding 0
            SD24MC_0 = 0b00,
            /// SD24B Manchaster Encoding 1
            SD24MC_1 = 0b01,
    ...
    /// SD24B Channel 6 Input Control Register
    rw SD24BINCTL6 @ 0x42: u16 = 0_0 {
        /// SD24B Input Pre-Amplifier Gain Select 0
        SD24BINCTL6_SD24GAIN: 3..5 = enum SD24BINCTL6_SD24GAIN {
            /// SD24B Input Pre-Amplifier Gain Select *1
            SD24GAIN_1 = 0b000,
            /// SD24B Input Pre-Amplifier Gain Select *2
            SD24GAIN_2 = 0b001,
        ...
        /// SD24B Interrupt Delay after 1.Conversion 0
        SD24BINCTL6_SD24INTDLY: 6..7 = enum SD24BINCTL6_SD24INTDLY {
            /// SD24B Interrupt Delay: Int. after 4.Conversion
            SD24INTDLY_0 = 0b00,
            /// SD24B Interrupt Delay: Int. after 3.Conversion
            SD24INTDLY_1 = 0b01,
    ...
    /// SD24B Channel 6 OSR Control Register
    rw SD24BOSR6 @ 0x44: u16 = 0_0 {
        /// SD24B Oversampling Rate Bit: 0
        SD24BOSR6_OSR0: 0 = struct SD24BOSR6_OSR0(bool);
        /// SD24B Oversampling Rate Bit: 1
        SD24BOSR6_OSR1: 1 = struct SD24BOSR6_OSR1(bool);
        /// SD24B Oversampling Rate Bit: 2
        SD24BOSR6_OSR2: 2 = struct SD24BOSR6_OSR2(bool);
        /// SD24B Oversampling Rate Bit: 3
        SD24BOSR6_OSR3: 3 = struct SD24BOSR6_OSR3(bool);
        /// SD24B Oversampling Rate Bit: 4
        SD24BOSR6_OSR4: 4 = struct SD24BOSR6_OSR4(bool);
        /// SD24B Oversampling Rate Bit: 5
        SD24BOSR6_OSR5: 5 = struct SD24BOSR6_OSR5(bool);
        /// SD24B Oversampling Rate Bit: 6
        SD24BOSR6_OSR6: 6 = struct SD24BOSR6_OSR6(bool);
        /// SD24B Oversampling Rate Bit: 7
        SD24BOSR6_OSR7: 7 = struct SD24BOSR6_OSR7(bool);
        /// SD24B Oversampling Rate Bit: 8
        SD24BOSR6_OSR8: 8 = struct SD24BOSR6_OSR8(bool);
        /// SD24B Oversampling Rate Bit: 9
        SD24BOSR6_OSR9: 9 = struct SD24BOSR6_OSR9(bool);
        /// SD24B Oversampling Rate Bit: 10
        SD24BOSR6_OSR10: 10 = struct SD24BOSR6_OSR10(bool);
    }
    /// SD24B Channel 6 Preload Register
    rw SD24BPRE6 @ 0x46: u16 = 0_0 {
        /// SD24B Channel 6 Preload Register
        SD24BPRE6: 0..15 = struct SD24BPRE6Field(u16);
    }
    ...
    /// SD24B Channel 6 Conversion Memory Low word
    rw SD24BMEML6 @ 0x68: u16 = 0_0 {
        /// SD24B Channel 6 Conversion Memory Low word
        SD24BMEML6: 0..15 = struct SD24BMEML6Field(u16);
    }
    /// SD24B Channel 6 Conversion Memory High Word
    rw SD24BMEMH6 @ 0x6a: u16 = 0_0 {
        /// SD24B Channel 6 Conversion Memory High Word
        SD24BMEMH6: 0..15 = struct SD24BMEMH6Field(u16);
    }
}
