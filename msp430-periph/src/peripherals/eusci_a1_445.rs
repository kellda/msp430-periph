...
utils::periph! {
    ...
    rw UCA1CTLW0 @ 0x00: u16 = 0_0 {
        ...
        UCA1CTLW0_UCSWRST: 0 = enum UCA1CTLW0_UCSWRST {
        ...
        UCA1CTLW0_UCSYNC: 8 = enum UCA1CTLW0_UCSYNC {
            /// Asynchronous mode
            ASYNC = 0b0,
            /// Synchronous mode
            SYNC = 0b1,
        ...
        /// Character length
        UCA1CTLW0_UC7BIT: 12 = enum UCA1CTLW0_UC7BIT {
            /// 8-bit data
            _8BIT = 0b0,
            /// 7-bit data
            _7BIT = 0b1,
        ...
        /// MSB first select
        UCA1CTLW0_UCMSB: 13 = enum UCA1CTLW0_UCMSB {
            /// LSB first
            UCMSB_0 = 0b0,
            /// MSB first
            UCMSB_1 = 0b1,
    ...
    rw UCA1CTLW0_SPI @ 0x00: u16 = 0_0 {
        /// Software reset enable
        UCA1CTLW0_SPI_UCSWRST: 0 = enum UCA1CTLW0_SPI_UCSWRST {
            /// Disabled. eUSCI_A reset released for operation
            DISABLE = 0b0,
            /// Enabled. eUSCI_A logic held in reset state
            ENABLE = 0b1,
        ...
        /// Synchronous mode enable
        UCA1CTLW0_SPI_UCSYNC: 8 = enum UCA1CTLW0_SPI_UCSYNC {
            /// Asynchronous mode
            ASYNC = 0b0,
            /// Synchronous mode
            SYNC = 0b1,
        ...
        /// Character length
        UCA1CTLW0_SPI_UC7BIT: 12 = enum UCA1CTLW0_SPI_UC7BIT {
            /// 8-bit data
            _8BIT = 0b0,
            /// 7-bit data
            _7BIT = 0b1,
        ...
        /// MSB first select
        UCA1CTLW0_SPI_UCMSB: 13 = enum UCA1CTLW0_SPI_UCMSB {
            /// LSB first
            UCMSB_0 = 0b0,
            /// MSB first
            UCMSB_1 = 0b1,
    ...
    rw UCA1STATW @ 0x0a: u16 = 0_0 {
        ...
        /// Overrun error flag
        UCA1STATW_UCOE: 5 = enum UCA1STATW_UCOE {
            /// No error
            UCOE_0 = 0b0,
        ...
        /// Framing error flag
        UCA1STATW_UCFE: 6 = enum UCA1STATW_UCFE {
            /// No error
            UCFE_0 = 0b0,
        ...
        /// Listen enable
        UCA1STATW_UCLISTEN: 7 = enum UCA1STATW_UCLISTEN {
            /// Disabled
            UCLISTEN_0 = 0b0,
    ...
    rw UCA1STATW_SPI @ 0x0a: u16 = 0_0 {
        /// Overrun error flag
        UCA1STATW_SPI_UCOE: 5 = enum UCA1STATW_SPI_UCOE {
            /// No error
            UCOE_0 = 0b0,
            /// Overrun error occurred
            UCOE_1 = 0b1,
        ...
        /// Framing error flag
        UCA1STATW_SPI_UCFE: 6 = enum UCA1STATW_SPI_UCFE {
            /// No error
            UCFE_0 = 0b0,
        ...
        /// Listen enable
        UCA1STATW_SPI_UCLISTEN: 7 = enum UCA1STATW_SPI_UCLISTEN {
            /// Disabled
            UCLISTEN_0 = 0b0,
            /// Enabled. UCAxTXD is internally fed back to the receiver
            UCLISTEN_1 = 0b1,
    ...
    rw UCA1IE @ 0x1a: u16 = 0_0 {
        ...
        UCA1IE_UCRXIE: 0 = enum UCA1IE_UCRXIE {
            /// Interrupt disabled
            UCRXIE_0 = 0b0,
            /// Interrupt enabled
            UCRXIE_1 = 0b1,
        ...
        UCA1IE_UCTXIE: 1 = enum UCA1IE_UCTXIE {
            /// Interrupt disabled
            UCTXIE_0 = 0b0,
            /// Interrupt enabled
            UCTXIE_1 = 0b1,
    ...
    rw UCA1IE_SPI @ 0x1a: u16 = 0_0 {
        /// Receive interrupt enable
        UCA1IE_SPI_UCRXIE: 0 = enum UCA1IE_SPI_UCRXIE {
            /// Interrupt disabled
            UCRXIE_0 = 0b0,
            /// Interrupt enabled
            UCRXIE_1 = 0b1,
        ...
        /// Transmit interrupt enable
        UCA1IE_SPI_UCTXIE: 1 = enum UCA1IE_SPI_UCTXIE {
            /// Interrupt disabled
            UCTXIE_0 = 0b0,
            /// Interrupt enabled
            UCTXIE_1 = 0b1,
    ...
    rw UCA1IFG @ 0x1c: u16 = 0_0 {
        ...
        UCA1IFG_UCRXIFG: 0 = enum UCA1IFG_UCRXIFG {
        ...
        UCA1IFG_UCTXIFG: 1 = enum UCA1IFG_UCTXIFG {
            /// No interrupt pending
            UCTXIFG_0 = 0b0,
            /// Interrupt pending
            UCTXIFG_1 = 0b1,
    ...
    rw UCA1IFG_SPI @ 0x1c: u16 = 0_0 {
        /// Receive interrupt flag
        UCA1IFG_SPI_UCRXIFG: 0 = enum UCA1IFG_SPI_UCRXIFG {
            /// No interrupt pending
            UCRXIFG_0 = 0b0,
            /// Interrupt pending
            UCRXIFG_1 = 0b1,
        ...
        /// Transmit interrupt flag
        UCA1IFG_SPI_UCTXIFG: 1 = enum UCA1IFG_SPI_UCTXIFG {
            /// No interrupt pending
            UCTXIFG_0 = 0b0,
            /// Interrupt pending
            UCTXIFG_1 = 0b1,
