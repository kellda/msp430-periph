...
utils::periph! {
    ...
    rw UCA2CTLW0 @ 0x00: u16 = 0_0 {
        ...
        UCA2CTLW0_UCSWRST: 0 = enum UCA2CTLW0_UCSWRST {
        ...
        UCA2CTLW0_UCSYNC: 8 = enum UCA2CTLW0_UCSYNC {
            /// Asynchronous mode
            ASYNC = 0b0,
            /// Synchronous mode
            SYNC = 0b1,
        ...
        /// Character length
        UCA2CTLW0_UC7BIT: 12 = enum UCA2CTLW0_UC7BIT {
            /// 8-bit data
            _8BIT = 0b0,
            /// 7-bit data
            _7BIT = 0b1,
        ...
        /// MSB first select
        UCA2CTLW0_UCMSB: 13 = enum UCA2CTLW0_UCMSB {
            /// LSB first
            UCMSB_0 = 0b0,
            /// MSB first
            UCMSB_1 = 0b1,
    ...
    rw UCA2CTLW0_SPI @ 0x00: u16 = 0_0 {
        /// Software reset enable
        UCA2CTLW0_SPI_UCSWRST: 0 = enum UCA2CTLW0_SPI_UCSWRST {
            /// Disabled. eUSCI_A reset released for operation
            DISABLE = 0b0,
            /// Enabled. eUSCI_A logic held in reset state
            ENABLE = 0b1,
        ...
        /// Synchronous mode enable
        UCA2CTLW0_SPI_UCSYNC: 8 = enum UCA2CTLW0_SPI_UCSYNC {
            /// Asynchronous mode
            ASYNC = 0b0,
            /// Synchronous mode
            SYNC = 0b1,
        ...
        /// Character length
        UCA2CTLW0_SPI_UC7BIT: 12 = enum UCA2CTLW0_SPI_UC7BIT {
            /// 8-bit data
            _8BIT = 0b0,
            /// 7-bit data
            _7BIT = 0b1,
        ...
        /// MSB first select
        UCA2CTLW0_SPI_UCMSB: 13 = enum UCA2CTLW0_SPI_UCMSB {
            /// LSB first
            UCMSB_0 = 0b0,
            /// MSB first
            UCMSB_1 = 0b1,
    ...
    rw UCA2STATW @ 0x0a: u16 = 0_0 {
        ...
        /// Overrun error flag
        UCA2STATW_UCOE: 5 = enum UCA2STATW_UCOE {
            /// No error
            UCOE_0 = 0b0,
        ...
        /// Framing error flag
        UCA2STATW_UCFE: 6 = enum UCA2STATW_UCFE {
            /// No error
            UCFE_0 = 0b0,
        ...
        /// Listen enable
        UCA2STATW_UCLISTEN: 7 = enum UCA2STATW_UCLISTEN {
            /// Disabled
            UCLISTEN_0 = 0b0,
    ...
    rw UCA2STATW_SPI @ 0x0a: u16 = 0_0 {
        /// Overrun error flag
        UCA2STATW_SPI_UCOE: 5 = enum UCA2STATW_SPI_UCOE {
            /// No error
            UCOE_0 = 0b0,
            /// Overrun error occurred
            UCOE_1 = 0b1,
        ...
        /// Framing error flag
        UCA2STATW_SPI_UCFE: 6 = enum UCA2STATW_SPI_UCFE {
            /// No error
            UCFE_0 = 0b0,
        ...
        /// Listen enable
        UCA2STATW_SPI_UCLISTEN: 7 = enum UCA2STATW_SPI_UCLISTEN {
            /// Disabled
            UCLISTEN_0 = 0b0,
            /// Enabled. UCAxTXD is internally fed back to the receiver
            UCLISTEN_1 = 0b1,
    ...
    rw UCA2IE @ 0x1a: u16 = 0_0 {
        ...
        UCA2IE_UCRXIE: 0 = enum UCA2IE_UCRXIE {
            /// Interrupt disabled
            UCRXIE_0 = 0b0,
            /// Interrupt enabled
            UCRXIE_1 = 0b1,
        ...
        UCA2IE_UCTXIE: 1 = enum UCA2IE_UCTXIE {
            /// Interrupt disabled
            UCTXIE_0 = 0b0,
            /// Interrupt enabled
            UCTXIE_1 = 0b1,
    ...
    rw UCA2IE_SPI @ 0x1a: u16 = 0_0 {
        /// Receive interrupt enable
        UCA2IE_SPI_UCRXIE: 0 = enum UCA2IE_SPI_UCRXIE {
            /// Interrupt disabled
            UCRXIE_0 = 0b0,
            /// Interrupt enabled
            UCRXIE_1 = 0b1,
        ...
        /// Transmit interrupt enable
        UCA2IE_SPI_UCTXIE: 1 = enum UCA2IE_SPI_UCTXIE {
            /// Interrupt disabled
            UCTXIE_0 = 0b0,
            /// Interrupt enabled
            UCTXIE_1 = 0b1,
    ...
    rw UCA2IFG @ 0x1c: u16 = 0_0 {
        ...
        UCA2IFG_UCRXIFG: 0 = enum UCA2IFG_UCRXIFG {
        ...
        UCA2IFG_UCTXIFG: 1 = enum UCA2IFG_UCTXIFG {
            /// No interrupt pending
            UCTXIFG_0 = 0b0,
            /// Interrupt pending
            UCTXIFG_1 = 0b1,
    ...
    rw UCA2IFG_SPI @ 0x1c: u16 = 0_0 {
        /// Receive interrupt flag
        UCA2IFG_SPI_UCRXIFG: 0 = enum UCA2IFG_SPI_UCRXIFG {
            /// No interrupt pending
            UCRXIFG_0 = 0b0,
            /// Interrupt pending
            UCRXIFG_1 = 0b1,
        ...
        /// Transmit interrupt flag
        UCA2IFG_SPI_UCTXIFG: 1 = enum UCA2IFG_SPI_UCTXIFG {
            /// No interrupt pending
            UCTXIFG_0 = 0b0,
            /// Interrupt pending
            UCTXIFG_1 = 0b1,
