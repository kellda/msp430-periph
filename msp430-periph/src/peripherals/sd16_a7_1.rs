...
utils::periph! {
    ...
    rw SD16INCTL3 @ 0x03: u8 = 0_0 {
        /// SD16 Input Channel select 0
        SD16INCTL3_SD16INCH: 0..2 = enum SD16INCTL3_SD16INCH {
            /// SD16 Input Channel select input
            SD16INCH_0 = 0b000,
            /// SD16 Input Channel select input
            SD16INCH_1 = 0b001,
        ...
        /// SD16 Input Pre-Amplifier Gain Select 0
        SD16INCTL3_SD16GAIN0: 3 = struct SD16INCTL3_SD16GAIN0(bool);
        /// SD16 Input Pre-Amplifier Gain Select 1
        SD16INCTL3_SD16GAIN1: 4 = struct SD16INCTL3_SD16GAIN1(bool);
        /// SD16 Input Pre-Amplifier Gain Select 2
        SD16INCTL3_SD16GAIN2: 5 = struct SD16INCTL3_SD16GAIN2(bool);
        /// SD16 Interrupt Delay after 1.Conversion 0
        SD16INCTL3_SD16INTDLY: 6..7 = enum SD16INCTL3_SD16INTDLY {
            /// SD16 Interrupt Delay: Int. after 4.Conversion
            SD16INTDLY_0 = 0b00,
            /// SD16 Interrupt Delay: Int. after 3.Conversion
            SD16INTDLY_1 = 0b01,
    ...
    rw SD16INCTL4 @ 0x04: u8 = 0_0 {
        /// SD16 Input Channel select 0
        SD16INCTL4_SD16INCH: 0..2 = enum SD16INCTL4_SD16INCH {
            /// SD16 Input Channel select input
            SD16INCH_0 = 0b000,
            /// SD16 Input Channel select input
            SD16INCH_1 = 0b001,
        ...
        /// SD16 Input Pre-Amplifier Gain Select 0
        SD16INCTL4_SD16GAIN0: 3 = struct SD16INCTL4_SD16GAIN0(bool);
        /// SD16 Input Pre-Amplifier Gain Select 1
        SD16INCTL4_SD16GAIN1: 4 = struct SD16INCTL4_SD16GAIN1(bool);
        /// SD16 Input Pre-Amplifier Gain Select 2
        SD16INCTL4_SD16GAIN2: 5 = struct SD16INCTL4_SD16GAIN2(bool);
        /// SD16 Interrupt Delay after 1.Conversion 0
        SD16INCTL4_SD16INTDLY: 6..7 = enum SD16INCTL4_SD16INTDLY {
            /// SD16 Interrupt Delay: Int. after 4.Conversion
            SD16INTDLY_0 = 0b00,
            /// SD16 Interrupt Delay: Int. after 3.Conversion
            SD16INTDLY_1 = 0b01,
    ...
    rw SD16INCTL5 @ 0x05: u8 = 0_0 {
        /// SD16 Input Channel select 0
        SD16INCTL5_SD16INCH: 0..2 = enum SD16INCTL5_SD16INCH {
            /// SD16 Input Channel select input
            SD16INCH_0 = 0b000,
            /// SD16 Input Channel select input
            SD16INCH_1 = 0b001,
        ...
        /// SD16 Input Pre-Amplifier Gain Select 0
        SD16INCTL5_SD16GAIN0: 3 = struct SD16INCTL5_SD16GAIN0(bool);
        /// SD16 Input Pre-Amplifier Gain Select 1
        SD16INCTL5_SD16GAIN1: 4 = struct SD16INCTL5_SD16GAIN1(bool);
        /// SD16 Input Pre-Amplifier Gain Select 2
        SD16INCTL5_SD16GAIN2: 5 = struct SD16INCTL5_SD16GAIN2(bool);
        /// SD16 Interrupt Delay after 1.Conversion 0
        SD16INCTL5_SD16INTDLY: 6..7 = enum SD16INCTL5_SD16INTDLY {
            /// SD16 Interrupt Delay: Int. after 4.Conversion
            SD16INTDLY_0 = 0b00,
            /// SD16 Interrupt Delay: Int. after 3.Conversion
            SD16INTDLY_1 = 0b01,
    ...
    /// SD16 Input Control Register Channel 6
    rw SD16INCTL6 @ 0x06: u8 = 0_0 {
        /// SD16 Input Channel select 0
        SD16INCTL6_SD16INCH: 0..2 = enum SD16INCTL6_SD16INCH {
            /// SD16 Input Channel select input
            SD16INCH_0 = 0b000,
            /// SD16 Input Channel select input
            SD16INCH_1 = 0b001,
        ...
        /// SD16 Input Pre-Amplifier Gain Select 0
        SD16INCTL6_SD16GAIN0: 3 = struct SD16INCTL6_SD16GAIN0(bool);
        /// SD16 Input Pre-Amplifier Gain Select 1
        SD16INCTL6_SD16GAIN1: 4 = struct SD16INCTL6_SD16GAIN1(bool);
        /// SD16 Input Pre-Amplifier Gain Select 2
        SD16INCTL6_SD16GAIN2: 5 = struct SD16INCTL6_SD16GAIN2(bool);
        /// SD16 Interrupt Delay after 1.Conversion 0
        SD16INCTL6_SD16INTDLY: 6..7 = enum SD16INCTL6_SD16INTDLY {
            /// SD16 Interrupt Delay: Int. after 4.Conversion
            SD16INTDLY_0 = 0b00,
            /// SD16 Interrupt Delay: Int. after 3.Conversion
            SD16INTDLY_1 = 0b01,
    ...
    rw SD16PRE3 @ 0x0b: u8 = 0_0 {
        /// SD16 Preload Register Channel 3
        SD16PRE3: 0..7 = struct SD16PRE3Field(u8);
    }
    /// SD16 Preload Register Channel 4
    rw SD16PRE4 @ 0x0c: u8 = 0_0 {
        /// SD16 Preload Register Channel 4
        SD16PRE4: 0..7 = struct SD16PRE4Field(u8);
    }
    /// SD16 Preload Register Channel 5
    rw SD16PRE5 @ 0x0d: u8 = 0_0 {
        /// SD16 Preload Register Channel 5
        SD16PRE5: 0..7 = struct SD16PRE5Field(u8);
    }
    /// SD16 Preload Register Channel 6
    rw SD16PRE6 @ 0x0e: u8 = 0_0 {
        /// SD16 Preload Register Channel 6
        SD16PRE6: 0..7 = struct SD16PRE6Field(u8);
    }
    ...
    rw SD16CCTL3 @ 0x58: u16 = 0_0 {
        /// SD16 Grouping of Channels: 0:Off/1:On
        SD16CCTL3_SD16GRP: 0 = struct SD16CCTL3_SD16GRP(bool);
        /// SD16 Start Conversion
        SD16CCTL3_SD16SC: 1 = struct SD16CCTL3_SD16SC(bool);
        /// SD16 Channel x Interrupt Flag
        SD16CCTL3_SD16IFG: 2 = struct SD16CCTL3_SD16IFG(bool);
        /// SD16 Channel x Interrupt Enable
        SD16CCTL3_SD16IE: 3 = struct SD16CCTL3_SD16IE(bool);
        /// SD16 Channel x Data Format: 0:Unipolar/1:Bipolar
        SD16CCTL3_SD16DF: 4 = struct SD16CCTL3_SD16DF(bool);
        /// SD16 Channel x Overflow Interrupt Flag
        SD16CCTL3_SD16OVIFG: 5 = struct SD16CCTL3_SD16OVIFG(bool);
        /// SD16 Channel x Access LSB of ADC
        SD16CCTL3_SD16LSBACC: 6 = struct SD16CCTL3_SD16LSBACC(bool);
        /// SD16 Channel x Toggle LSB Output of ADC
        SD16CCTL3_SD16LSBTOG: 7 = struct SD16CCTL3_SD16LSBTOG(bool);
        /// SD16 Channel x OverSampling Ratio 0
        SD16CCTL3_SD16OSR0: 8 = struct SD16CCTL3_SD16OSR0(bool);
        /// SD16 Channel x OverSampling Ratio 1
        SD16CCTL3_SD16OSR1: 9 = struct SD16CCTL3_SD16OSR1(bool);
        /// SD16 Channel x Single Conversion On/Off
        SD16CCTL3_SD16SNGL: 10 = struct SD16CCTL3_SD16SNGL(bool);
        /// SD16 Channel x Extended OverSampling Ratio
        SD16CCTL3_SD16XOSR: 11 = struct SD16CCTL3_SD16XOSR(bool);
        /// SD16 Channel x Bipolar(0) / Unipolar(1) Mode
        SD16CCTL3_SD16UNI: 12 = struct SD16CCTL3_SD16UNI(bool);
    }
    /// SD16 Channel 4 Control Register
    rw SD16CCTL4 @ 0x5a: u16 = 0_0 {
        /// SD16 Grouping of Channels: 0:Off/1:On
        SD16CCTL4_SD16GRP: 0 = struct SD16CCTL4_SD16GRP(bool);
        /// SD16 Start Conversion
        SD16CCTL4_SD16SC: 1 = struct SD16CCTL4_SD16SC(bool);
        /// SD16 Channel x Interrupt Flag
        SD16CCTL4_SD16IFG: 2 = struct SD16CCTL4_SD16IFG(bool);
        /// SD16 Channel x Interrupt Enable
        SD16CCTL4_SD16IE: 3 = struct SD16CCTL4_SD16IE(bool);
        /// SD16 Channel x Data Format: 0:Unipolar/1:Bipolar
        SD16CCTL4_SD16DF: 4 = struct SD16CCTL4_SD16DF(bool);
        /// SD16 Channel x Overflow Interrupt Flag
        SD16CCTL4_SD16OVIFG: 5 = struct SD16CCTL4_SD16OVIFG(bool);
        /// SD16 Channel x Access LSB of ADC
        SD16CCTL4_SD16LSBACC: 6 = struct SD16CCTL4_SD16LSBACC(bool);
        /// SD16 Channel x Toggle LSB Output of ADC
        SD16CCTL4_SD16LSBTOG: 7 = struct SD16CCTL4_SD16LSBTOG(bool);
        /// SD16 Channel x OverSampling Ratio 0
        SD16CCTL4_SD16OSR0: 8 = struct SD16CCTL4_SD16OSR0(bool);
        /// SD16 Channel x OverSampling Ratio 1
        SD16CCTL4_SD16OSR1: 9 = struct SD16CCTL4_SD16OSR1(bool);
        /// SD16 Channel x Single Conversion On/Off
        SD16CCTL4_SD16SNGL: 10 = struct SD16CCTL4_SD16SNGL(bool);
        /// SD16 Channel x Extended OverSampling Ratio
        SD16CCTL4_SD16XOSR: 11 = struct SD16CCTL4_SD16XOSR(bool);
        /// SD16 Channel x Bipolar(0) / Unipolar(1) Mode
        SD16CCTL4_SD16UNI: 12 = struct SD16CCTL4_SD16UNI(bool);
    }
    /// SD16 Channel 5 Control Register
    rw SD16CCTL5 @ 0x5c: u16 = 0_0 {
        /// SD16 Grouping of Channels: 0:Off/1:On
        SD16CCTL5_SD16GRP: 0 = struct SD16CCTL5_SD16GRP(bool);
        /// SD16 Start Conversion
        SD16CCTL5_SD16SC: 1 = struct SD16CCTL5_SD16SC(bool);
        /// SD16 Channel x Interrupt Flag
        SD16CCTL5_SD16IFG: 2 = struct SD16CCTL5_SD16IFG(bool);
        /// SD16 Channel x Interrupt Enable
        SD16CCTL5_SD16IE: 3 = struct SD16CCTL5_SD16IE(bool);
        /// SD16 Channel x Data Format: 0:Unipolar/1:Bipolar
        SD16CCTL5_SD16DF: 4 = struct SD16CCTL5_SD16DF(bool);
        /// SD16 Channel x Overflow Interrupt Flag
        SD16CCTL5_SD16OVIFG: 5 = struct SD16CCTL5_SD16OVIFG(bool);
        /// SD16 Channel x Access LSB of ADC
        SD16CCTL5_SD16LSBACC: 6 = struct SD16CCTL5_SD16LSBACC(bool);
        /// SD16 Channel x Toggle LSB Output of ADC
        SD16CCTL5_SD16LSBTOG: 7 = struct SD16CCTL5_SD16LSBTOG(bool);
        /// SD16 Channel x OverSampling Ratio 0
        SD16CCTL5_SD16OSR0: 8 = struct SD16CCTL5_SD16OSR0(bool);
        /// SD16 Channel x OverSampling Ratio 1
        SD16CCTL5_SD16OSR1: 9 = struct SD16CCTL5_SD16OSR1(bool);
        /// SD16 Channel x Single Conversion On/Off
        SD16CCTL5_SD16SNGL: 10 = struct SD16CCTL5_SD16SNGL(bool);
        /// SD16 Channel x Extended OverSampling Ratio
        SD16CCTL5_SD16XOSR: 11 = struct SD16CCTL5_SD16XOSR(bool);
        /// SD16 Channel x Bipolar(0) / Unipolar(1) Mode
        SD16CCTL5_SD16UNI: 12 = struct SD16CCTL5_SD16UNI(bool);
    }
    /// SD16 Channel 6 Control Register
    rw SD16CCTL6 @ 0x5e: u16 = 0_0 {
        /// SD16 Grouping of Channels: 0:Off/1:On
        SD16CCTL6_SD16GRP: 0 = struct SD16CCTL6_SD16GRP(bool);
        /// SD16 Start Conversion
        SD16CCTL6_SD16SC: 1 = struct SD16CCTL6_SD16SC(bool);
        /// SD16 Channel x Interrupt Flag
        SD16CCTL6_SD16IFG: 2 = struct SD16CCTL6_SD16IFG(bool);
        /// SD16 Channel x Interrupt Enable
        SD16CCTL6_SD16IE: 3 = struct SD16CCTL6_SD16IE(bool);
        /// SD16 Channel x Data Format: 0:Unipolar/1:Bipolar
        SD16CCTL6_SD16DF: 4 = struct SD16CCTL6_SD16DF(bool);
        /// SD16 Channel x Overflow Interrupt Flag
        SD16CCTL6_SD16OVIFG: 5 = struct SD16CCTL6_SD16OVIFG(bool);
        /// SD16 Channel x Access LSB of ADC
        SD16CCTL6_SD16LSBACC: 6 = struct SD16CCTL6_SD16LSBACC(bool);
        /// SD16 Channel x Toggle LSB Output of ADC
        SD16CCTL6_SD16LSBTOG: 7 = struct SD16CCTL6_SD16LSBTOG(bool);
        /// SD16 Channel x OverSampling Ratio 0
        SD16CCTL6_SD16OSR0: 8 = struct SD16CCTL6_SD16OSR0(bool);
        /// SD16 Channel x OverSampling Ratio 1
        SD16CCTL6_SD16OSR1: 9 = struct SD16CCTL6_SD16OSR1(bool);
        /// SD16 Channel x Single Conversion On/Off
        SD16CCTL6_SD16SNGL: 10 = struct SD16CCTL6_SD16SNGL(bool);
        /// SD16 Channel x Extended OverSampling Ratio
        SD16CCTL6_SD16XOSR: 11 = struct SD16CCTL6_SD16XOSR(bool);
        /// SD16 Channel x Bipolar(0) / Unipolar(1) Mode
        SD16CCTL6_SD16UNI: 12 = struct SD16CCTL6_SD16UNI(bool);
    }
    /// SD16 Channel 0 Conversion Memory
    rw SD16MEM0 @ 0x60: u16 = 0_0 {
        /// SD16 Channel 0 Conversion Memory
        SD16MEM0: 0..15 = struct SD16MEM0Field(u16);
    }
    /// SD16 Channel 1 Conversion Memory
    rw SD16MEM1 @ 0x62: u16 = 0_0 {
        /// SD16 Channel 1 Conversion Memory
        SD16MEM1: 0..15 = struct SD16MEM1Field(u16);
    }
    /// SD16 Channel 2 Conversion Memory
    rw SD16MEM2 @ 0x64: u16 = 0_0 {
        /// SD16 Channel 2 Conversion Memory
        SD16MEM2: 0..15 = struct SD16MEM2Field(u16);
    }
    /// SD16 Channel 3 Conversion Memory
    rw SD16MEM3 @ 0x66: u16 = 0_0 {
        /// SD16 Channel 3 Conversion Memory
        SD16MEM3: 0..15 = struct SD16MEM3Field(u16);
    }
    /// SD16 Channel 4 Conversion Memory
    rw SD16MEM4 @ 0x68: u16 = 0_0 {
        /// SD16 Channel 4 Conversion Memory
        SD16MEM4: 0..15 = struct SD16MEM4Field(u16);
    }
    /// SD16 Channel 5 Conversion Memory
    rw SD16MEM5 @ 0x6a: u16 = 0_0 {
        /// SD16 Channel 5 Conversion Memory
        SD16MEM5: 0..15 = struct SD16MEM5Field(u16);
    }
    /// SD16 Channel 6 Conversion Memory
    rw SD16MEM6 @ 0x6c: u16 = 0_0 {
        /// SD16 Channel 6 Conversion Memory
        SD16MEM6: 0..15 = struct SD16MEM6Field(u16);
    }
    /// SD16 Interrupt Vector Register
    rw SD16IV @ 0xfe: u16 = 0_0 {
        /// SD16 Interrupt Vector Register
