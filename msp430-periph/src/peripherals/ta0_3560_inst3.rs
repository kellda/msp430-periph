...
utils::periph! {
    ...
    rw TA0CCTL0 @ 0x02: u16 = 0_0 {
        ...
        TA0CCTL0_CCIFG: 0..0 = enum TA0CCTL0_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA0CCTL0_COV: 1..1 = enum TA0CCTL0_COV {
        ...
        /// Output
        TA0CCTL0_OUT: 2..2 = enum TA0CCTL0_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        TA0CCTL0_CCIE: 4..4 = enum TA0CCTL0_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA0CCTL0_CAP: 8..8 = enum TA0CCTL0_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        TA0CCTL0_SCS: 11..11 = enum TA0CCTL0_SCS {
    ...
    rw TA0CCTL1 @ 0x04: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA0CCTL1_CCIFG: 0..0 = enum TA0CCTL1_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA0CCTL1_COV: 1..1 = enum TA0CCTL1_COV {
            /// No capture overflow occurred
            COV_0 = 0b0,
            /// Capture overflow occurred
            COV_1 = 0b1,
        ...
        /// Output
        TA0CCTL1_OUT: 2..2 = enum TA0CCTL1_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        /// Capture/compare interrupt enable
        TA0CCTL1_CCIE: 4..4 = enum TA0CCTL1_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA0CCTL1_CAP: 8..8 = enum TA0CCTL1_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        /// Synchronize capture source
        TA0CCTL1_SCS: 11..11 = enum TA0CCTL1_SCS {
            /// Asynchronous capture
            ASYNC = 0b0,
            /// Synchronous capture
            SYNC = 0b1,
    ...
    rw TA0CCTL2 @ 0x06: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA0CCTL2_CCIFG: 0..0 = enum TA0CCTL2_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA0CCTL2_COV: 1..1 = enum TA0CCTL2_COV {
            /// No capture overflow occurred
            COV_0 = 0b0,
            /// Capture overflow occurred
            COV_1 = 0b1,
        ...
        /// Output
        TA0CCTL2_OUT: 2..2 = enum TA0CCTL2_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        /// Capture/compare interrupt enable
        TA0CCTL2_CCIE: 4..4 = enum TA0CCTL2_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA0CCTL2_CAP: 8..8 = enum TA0CCTL2_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        /// Synchronize capture source
        TA0CCTL2_SCS: 11..11 = enum TA0CCTL2_SCS {
            /// Asynchronous capture
            ASYNC = 0b0,
            /// Synchronous capture
            SYNC = 0b1,
