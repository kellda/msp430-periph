...
utils::periph! {
    ...
    rw TA1CCTL3 @ 0x6a: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA1CCTL3_CCIFG: 0 = struct TA1CCTL3_CCIFG(bool);
        /// Capture/compare overflow flag
        TA1CCTL3_COV: 1 = struct TA1CCTL3_COV(bool);
        /// PWM Output signal if output mode 0
        TA1CCTL3_OUT: 2 = struct TA1CCTL3_OUT(bool);
        /// Capture input signal (read)
        TA1CCTL3_CCI: 3 = struct TA1CCTL3_CCI(bool);
        /// Capture/compare interrupt enable
        TA1CCTL3_CCIE: 4 = struct TA1CCTL3_CCIE(bool);
        /// Output mode 2
        ...
        /// Capture mode: 1 /Compare mode : 0
        TA1CCTL3_CAP: 8 = struct TA1CCTL3_CAP(bool);
        /// Latched capture signal (read)
        TA1CCTL3_SCCI: 10 = struct TA1CCTL3_SCCI(bool);
        /// Capture sychronize
        TA1CCTL3_SCS: 11 = struct TA1CCTL3_SCS(bool);
        /// Capture input select 1
    ...
    rw TA1CCTL4 @ 0x6c: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA1CCTL4_CCIFG: 0 = struct TA1CCTL4_CCIFG(bool);
        /// Capture/compare overflow flag
        TA1CCTL4_COV: 1 = struct TA1CCTL4_COV(bool);
        /// PWM Output signal if output mode 0
        TA1CCTL4_OUT: 2 = struct TA1CCTL4_OUT(bool);
        /// Capture input signal (read)
        TA1CCTL4_CCI: 3 = struct TA1CCTL4_CCI(bool);
        /// Capture/compare interrupt enable
        TA1CCTL4_CCIE: 4 = struct TA1CCTL4_CCIE(bool);
        /// Output mode 2
        ...
        /// Capture mode: 1 /Compare mode : 0
        TA1CCTL4_CAP: 8 = struct TA1CCTL4_CAP(bool);
        /// Latched capture signal (read)
        TA1CCTL4_SCCI: 10 = struct TA1CCTL4_SCCI(bool);
        /// Capture sychronize
        TA1CCTL4_SCS: 11 = struct TA1CCTL4_SCS(bool);
        /// Capture input select 1
