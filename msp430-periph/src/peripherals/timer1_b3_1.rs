...
utils::periph! {
    ...
    /// Timer1_B3 Capture/Compare Control 0
    rw TB1CCTL0 @ 0x02: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TB1CCTL0_CCIFG: 0 = struct TB1CCTL0_CCIFG(bool);
        /// Capture/compare overflow flag
        TB1CCTL0_COV: 1 = struct TB1CCTL0_COV(bool);
        /// PWM Output signal if output mode 0
        TB1CCTL0_OUT: 2 = struct TB1CCTL0_OUT(bool);
        /// Capture input signal (read)
        TB1CCTL0_CCI: 3 = struct TB1CCTL0_CCI(bool);
        /// Capture/compare interrupt enable
        TB1CCTL0_CCIE: 4 = struct TB1CCTL0_CCIE(bool);
        /// Output mode 2
        ...
        TB1CCTL0_CAP: 8 = struct TB1CCTL0_CAP(bool);
        ...
        /// Capture sychronize
        TB1CCTL0_SCS: 11 = struct TB1CCTL0_SCS(bool);
    ...
    /// Timer1_B3 Capture/Compare Control 1
    rw TB1CCTL1 @ 0x04: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TB1CCTL1_CCIFG: 0 = struct TB1CCTL1_CCIFG(bool);
        /// Capture/compare overflow flag
        TB1CCTL1_COV: 1 = struct TB1CCTL1_COV(bool);
        /// PWM Output signal if output mode 0
        TB1CCTL1_OUT: 2 = struct TB1CCTL1_OUT(bool);
        /// Capture input signal (read)
        TB1CCTL1_CCI: 3 = struct TB1CCTL1_CCI(bool);
        /// Capture/compare interrupt enable
        TB1CCTL1_CCIE: 4 = struct TB1CCTL1_CCIE(bool);
        /// Output mode 2
        ...
        /// Capture mode: 1 /Compare mode : 0
        TB1CCTL1_CAP: 8 = struct TB1CCTL1_CAP(bool);
        /// Compare latch load source 1
        ...
        /// Capture sychronize
        TB1CCTL1_SCS: 11 = struct TB1CCTL1_SCS(bool);
        /// Capture input select 1
    ...
    /// Timer1_B3 Capture/Compare Control 2
    rw TB1CCTL2 @ 0x06: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TB1CCTL2_CCIFG: 0 = struct TB1CCTL2_CCIFG(bool);
        /// Capture/compare overflow flag
        TB1CCTL2_COV: 1 = struct TB1CCTL2_COV(bool);
        /// PWM Output signal if output mode 0
        TB1CCTL2_OUT: 2 = struct TB1CCTL2_OUT(bool);
        /// Capture input signal (read)
        TB1CCTL2_CCI: 3 = struct TB1CCTL2_CCI(bool);
        /// Capture/compare interrupt enable
        TB1CCTL2_CCIE: 4 = struct TB1CCTL2_CCIE(bool);
        /// Output mode 2
        ...
        /// Capture mode: 1 /Compare mode : 0
        TB1CCTL2_CAP: 8 = struct TB1CCTL2_CAP(bool);
        /// Compare latch load source 1
        ...
        /// Capture sychronize
        TB1CCTL2_SCS: 11 = struct TB1CCTL2_SCS(bool);
        /// Capture input select 1
    ...
    /// Timer1_B3 Capture/Compare 0
    rw TB1CCR0 @ 0x12: u16 = 0_0 {
        /// Timer1_B3 Capture/Compare 0
        TB1CCR0: 0..15 = struct TB1CCR0Field(u16);
    }
    /// Timer1_B3 Capture/Compare 1
    rw TB1CCR1 @ 0x14: u16 = 0_0 {
        /// Timer1_B3 Capture/Compare 1
        TB1CCR1: 0..15 = struct TB1CCR1Field(u16);
    }
    /// Timer1_B3 Capture/Compare 2
    rw TB1CCR2 @ 0x16: u16 = 0_0 {
        /// Timer1_B3 Capture/Compare 2
        TB1CCR2: 0..15 = struct TB1CCR2Field(u16);
    }
    /// Timer1_B3 Interrupt Vector Word
    rw TB1IV @ 0x2e: u16 = 0_0 {
        /// Timer1_B3 Interrupt Vector Word
        TB1IV: 0..15 = struct TB1IVField(u16);
    }
    /// Timer1_B3 Expansion Register 0
