...
utils::periph! {
    ...
    rw UCA0CTL0 @ 0x01: u8 = 0_0 {
        /// USCI A0 Control Register 0
        UCA0CTL0: 0..7 = struct UCA0CTL0Field(u8);
    }
    /// USCI A0 Control Register 1
    rw UCA0CTL1 @ 0x00: u8 = 0_0 {
        /// USCI A0 Control Register 1
        UCA0CTL1: 0..7 = struct UCA0CTL1Field(u8);
    }
    ...
    rw UCA0RXBUF @ 0x0c: u16 = 0_0 {
        /// USCI A0 Receive Buffer
        UCA0RXBUF: 0..15 = struct UCA0RXBUFField(u16);
    }
    /// USCI A0 Transmit Buffer
    rw UCA0TXBUF @ 0x0e: u16 = 0_0 {
        /// USCI A0 Transmit Buffer
        UCA0TXBUF: 0..15 = struct UCA0TXBUFField(u16);
    }
    /// USCI A0 LIN Control
    ...
    rw UCA0IRTCTL @ 0x12: u8 = 0_0 {
        /// USCI A0 IrDA Transmit Control
        UCA0IRTCTL: 0..7 = struct UCA0IRTCTLField(u8);
    }
    /// USCI A0 IrDA Receive Control
    rw UCA0IRRCTL @ 0x13: u8 = 0_0 {
        /// USCI A0 IrDA Receive Control
        UCA0IRRCTL: 0..7 = struct UCA0IRRCTLField(u8);
    }
    /// USCI A0 Interrupt Enable Register
    rw UCA0IE @ 0x1a: u16 = 0_0 {
        /// USCI A0 Interrupt Enable Register
        UCA0IE: 0..15 = struct UCA0IEField(u16);
    }
    /// USCI A0 Interrupt Flags Register
    rw UCA0IFG @ 0x1c: u16 = 0_0 {
        /// USCI A0 Interrupt Flags Register
        UCA0IFG: 0..15 = struct UCA0IFGField(u16);
    }
    /// USCI A0 Interrupt Enable Register
    rw UCA0IE__UART @ 0x1a: u16 = 0_0 {
