...
utils::periph! {
    ...
    rw MPUCTL1 @ 0x02: u16 = 0_0 {
        ...
        MPUSEG1IFG: 0..0 = enum MPUSEG1IFG {
        ...
        MPUSEG2IFG: 1..1 = enum MPUSEG2IFG {
            /// No interrupt pending
            MPUSEG2IFG_0 = 0b0,
            /// Interrupt pending
            MPUSEG2IFG_1 = 0b1,
        ...
        MPUSEG3IFG: 2..2 = enum MPUSEG3IFG {
            /// No interrupt pending
            MPUSEG1IFG_0 = 0b0,
            /// Interrupt pending
            MPUSEG1IFG_1 = 0b1,
        ...
        MPUSEGIIFG: 3..3 = enum MPUSEGIIFG {
            /// No interrupt pending
            MPUSEGIIFG_0 = 0b0,
            /// Interrupt pending
            MPUSEGIIFG_1 = 0b1,
        ...
        MPUSEGIPIFG: 4..4 = enum MPUSEGIPIFG {
            /// No interrupt pending
            MPUSEG1IFG_0 = 0b0,
            /// Interrupt pending
            MPUSEG1IFG_1 = 0b1,
    ...
    rw MPUSAM @ 0x08: u16 = 0_0 {
        ...
        MPUSEG3XE: 10..10 = enum MPUSEG3XE {
        ...
        MPUSEG3VS: 11..11 = enum MPUSEG3VS {
        ...
        MPUSEGIRE: 12..12 = enum MPUSEGIRE {
        ...
        MPUSEGIWE: 13..13 = enum MPUSEGIWE {
        ...
        MPUSEGIXE: 14..14 = enum MPUSEGIXE {
        ...
        MPUSEGIVS: 15..15 = enum MPUSEGIVS {
