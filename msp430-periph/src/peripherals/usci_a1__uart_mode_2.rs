...
utils::periph! {
    ...
    rw UCA1CTLW0 @ 0x00: u16 = 0_0 {
        /// USCI A1 Control Word Register 0
        UCA1CTLW0: 0..15 = struct UCA1CTLW0Field(u16);
    }
    ...
    rw UCA1RXBUF @ 0x0c: u8 = 0_0 {
        /// USCI A1 Receive Buffer
        UCA1RXBUF: 0..7 = struct UCA1RXBUFField(u8);
    }
    /// USCI A1 Transmit Buffer
    rw UCA1TXBUF @ 0x0e: u8 = 0_0 {
        /// USCI A1 Transmit Buffer
        UCA1TXBUF: 0..7 = struct UCA1TXBUFField(u8);
    }
    /// USCI A1 LIN Control
    ...
    rw UCA1IRCTL @ 0x12: u16 = 0_0 {
        /// USCI A1 IrDA Transmit Control
        UCA1IRCTL: 0..15 = struct UCA1IRCTLField(u16);
    }
    /// USCI A1 IrDA Transmit Control
    ...
    rw UCA1ICTL @ 0x1c: u16 = 0_0 {
        /// USCI A1 Interrupt Enable Register
        UCA1ICTL: 0..15 = struct UCA1ICTLField(u16);
    }
    /// USCI A1 Interrupt Enable Register
    rw UCA1IE @ 0x1c: u8 = 0_0 {
