...
utils::periph! {
    ...
    rw UCB0CTLW0 @ 0x00: u16 = 0_0 {
        ...
        UCB0CTLW0_UCSWRST: 0..0 = enum UCB0CTLW0_UCSWRST {
        ...
        UCB0CTLW0_UCSSEL: 6..7 = enum UCB0CTLW0_UCSSEL {
            /// UCLKI
            UCLKI = 0b00,
            /// ACLK
            ACLK = 0b01,
        ...
        UCB0CTLW0_UCSYNC: 8..8 = enum UCB0CTLW0_UCSYNC {
            /// Asynchronous mode
            ASYNC = 0b0,
            /// Synchronous mode
            SYNC = 0b1,
        ...
        /// eUSCI_B mode
        UCB0CTLW0_UCMODE: 9..10 = enum UCB0CTLW0_UCMODE {
            /// 3-pin SPI
            UCMODE_0 = 0b00,
        ...
        /// Master mode select
        UCB0CTLW0_UCMST: 11..11 = enum UCB0CTLW0_UCMST {
            /// Slave mode
            SLAVE = 0b0,
            /// Master mode
            MASTER = 0b1,
    ...
    /// eUSCI_Bx Control Word Register 0
    rw UCB0CTLW0_SPI @ 0x00: u16 = 0_0 {
        /// Software reset enable
        UCB0CTLW0_SPI_UCSWRST: 0..0 = enum UCB0CTLW0_SPI_UCSWRST {
            /// Disabled. eUSCI_B reset released for operation
            DISABLE = 0b0,
            /// Enabled. eUSCI_B logic held in reset state
            ENABLE = 0b1,
        ...
        /// eUSCI_B clock source select
        UCB0CTLW0_SPI_UCSSEL: 6..7 = enum UCB0CTLW0_SPI_UCSSEL {
            /// Reserved
            UCSSEL_0 = 0b00,
            /// ACLK
            ACLK = 0b01,
        ...
        /// Synchronous mode enable
        UCB0CTLW0_SPI_UCSYNC: 8..8 = enum UCB0CTLW0_SPI_UCSYNC {
            /// Asynchronous mode
            ASYNC = 0b0,
            /// Synchronous mode
            SYNC = 0b1,
        ...
        /// eUSCI mode
        UCB0CTLW0_SPI_UCMODE: 9..10 = enum UCB0CTLW0_SPI_UCMODE {
            /// 3-pin SPI
            UCMODE_0 = 0b00,
        ...
        /// Master mode select
        UCB0CTLW0_SPI_UCMST: 11..11 = enum UCB0CTLW0_SPI_UCMST {
            /// Slave mode
            SLAVE = 0b0,
            /// Master mode
            MASTER = 0b1,
    ...
    rw UCB0BRW_SPI @ 0x06: u16 = 0_0 {
        /// eUSCI_Bx Bit Rate Control Register 1
        UCB0BRW_SPI: 0..15 = struct UCB0BRW_SPIField(u16);
    }
    /// eUSCI_Bx Status Register
    r UCB0STATW @ 0x08: u16 = 0_0 {
        /// Bus busy
        UCBBUSY: 4..4 = enum UCBBUSY {
            /// Bus inactive
            IDLE = 0b0,
            /// Bus busy
            BUSY = 0b1,
    ...
    r UCB0RXBUF @ 0x0c: u16 = 0_0 {
        /// Receive data buffer
        UCB0RXBUF_UCRXBUF: 0..7 = struct UCB0RXBUF_UCRXBUF(u16);
    }
    /// eUSCI_Bx Receive Buffer Register
    r UCB0RXBUF_SPI @ 0x0c: u16 = 0_0 {
        /// Receive data buffer
        UCB0RXBUF_SPI_UCRXBUF: 0..7 = struct UCB0RXBUF_SPI_UCRXBUF(u16);
    }
    /// eUSCI_Bx Transmit Buffer Register
    rw UCB0TXBUF @ 0x0e: u16 = 0_0 {
        /// Transmit data buffer
        UCB0TXBUF_UCTXBUF: 0..7 = struct UCB0TXBUF_UCTXBUF(u16);
    }
    /// eUSCI_Bx Transmit Buffer Register
    rw UCB0TXBUF_SPI @ 0x0e: u16 = 0_0 {
        /// Transmit data buffer
        UCB0TXBUF_SPI_UCTXBUF: 0..7 = struct UCB0TXBUF_SPI_UCTXBUF(u16);
    }
    ...
    rw UCB0I2COA0 @ 0x14: u16 = 0_0 {
        ...
        UCB0I2COA0_UCOAEN: 10..10 = enum UCB0I2COA0_UCOAEN {
    ...
    rw UCB0I2COA1 @ 0x16: u16 = 0_0 {
        ...
        /// Own Address enable register
        UCB0I2COA1_UCOAEN: 10..10 = enum UCB0I2COA1_UCOAEN {
    ...
    rw UCB0I2COA2 @ 0x18: u16 = 0_0 {
        ...
        /// Own Address enable register
        UCB0I2COA2_UCOAEN: 10..10 = enum UCB0I2COA2_UCOAEN {
    ...
    rw UCB0I2COA3 @ 0x1a: u16 = 0_0 {
        ...
        /// Own Address enable register
        UCB0I2COA3_UCOAEN: 10..10 = enum UCB0I2COA3_UCOAEN {
    ...
    /// eUSCI_Bx Interrupt Enable Register
    rw UCB0IE_SPI @ 0x2a: u16 = 0_0 {
        /// Receive interrupt enable
        UCRXIE: 0..0 = enum UCRXIE {
            /// Interrupt disabled
            UCRXIE_0 = 0b0,
            /// Interrupt enabled
            UCRXIE_1 = 0b1,
    ...
    rw UCB0IFG @ 0x2c: u16 = 0_0 {
        ...
        UCBIT9IFG: 14..14 = enum UCBIT9IFG {
            /// No interrupt pending
            UCBIT9IFG_0 = 0b0,
            /// Interrupt pending
            UCBIT9IFG_1 = 0b1,
    ...
    /// eUSCI_Bx Interrupt Flag Register
    rw UCB0IFG_SPI @ 0x2c: u16 = 0_0 {
        /// Receive interrupt flag
        UCRXIFG: 0..0 = enum UCRXIFG {
            /// No interrupt pending
            UCRXIFG_0 = 0b0,
            /// Interrupt pending
            UCRXIFG_1 = 0b1,
    ...
    r UCB0IV @ 0x2e: u16 = 0_0 {
        /// eUSCI_B interrupt vector value
        UCB0IV_UCIV: 0..15 = enum UCB0IV_UCIV {
            /// No interrupt pending
    ...
    /// eUSCI_Bx Interrupt Vector Register
    r UCB0IV_SPI @ 0x2e: u16 = 0_0 {
        /// eUSCI_B interrupt vector value
        UCB0IV_SPI_UCIV: 0..15 = enum UCB0IV_SPI_UCIV {
            /// No interrupt pending
            NONE = 0b0000000000000000,
