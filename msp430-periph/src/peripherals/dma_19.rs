...
utils::periph! {
    ...
    rw DMACTL0 @ 0x00: u16 = 0_0 {
        ...
        DMA0TSEL: 0..4 = enum DMA0TSEL {
            ...
            DMA0TSEL_6 = 0b00110,
            /// DMA channel 0 transfer select 7:  TimerB (TB0CCR0.IFG)
            DMA0TSEL_7 = 0b00111,
            /// DMA channel 0 transfer select 8:  TimerB (TB0CCR2.IFG)
            DMA0TSEL_8 = 0b01000,
            /// DMA channel 0 transfer select 9:  UCA2RXIFG
            DMA0TSEL_9 = 0b01001,
            /// DMA channel 0 transfer select 10: UCA2TXIFG
            DMA0TSEL_10 = 0b01010,
            /// DMA channel 0 transfer select 11: UCB2RXIFG
            DMA0TSEL_11 = 0b01011,
            /// DMA channel 0 transfer select 12: UCB2TXIFG
            DMA0TSEL_12 = 0b01100,
            /// DMA channel 0 transfer select 13: Reserved
            DMA0TSEL_13 = 0b01101,
            /// DMA channel 0 transfer select 14: Reserved
            DMA0TSEL_14 = 0b01110,
            /// DMA channel 0 transfer select 15: Reserved
            DMA0TSEL_15 = 0b01111,
            ...
            DMA0TSEL_24 = 0b11000,
            /// DMA channel 0 transfer select 25: UCA3RXIFG
            DMA0TSEL_25 = 0b11001,
            /// DMA channel 0 transfer select 26: UCA3RXIFG
            DMA0TSEL_26 = 0b11010,
            /// DMA channel 0 transfer select 27: UCB3RXIFG
            DMA0TSEL_27 = 0b11011,
            /// DMA channel 0 transfer select 28: UCB3TXIFG
            DMA0TSEL_28 = 0b11100,
        ...
        DMA1TSEL: 8..12 = enum DMA1TSEL {
            ...
            DMA1TSEL_8 = 0b01000,
            /// DMA channel 1 transfer select 9:  UCA2RXIFG
            DMA1TSEL_9 = 0b01001,
            /// DMA channel 1 transfer select 10: UCA2TXIFG
            DMA1TSEL_10 = 0b01010,
            /// DMA channel 1 transfer select 11: UCB2RXIFG
            DMA1TSEL_11 = 0b01011,
            /// DMA channel 1 transfer select 12: UCB2TXIFG
            DMA1TSEL_12 = 0b01100,
            ...
            DMA1TSEL_24 = 0b11000,
            /// DMA channel 1 transfer select 25: UCA3RXIFG
            DMA1TSEL_25 = 0b11001,
            /// DMA channel 1 transfer select 26: UCA3TXIFG
            DMA1TSEL_26 = 0b11010,
            /// DMA channel 1 transfer select 27: UCB3RXIFG
            DMA1TSEL_27 = 0b11011,
            /// DMA channel 1 transfer select 28: UCB3TXIFG
            DMA1TSEL_28 = 0b11100,
    ...
    rw DMACTL1 @ 0x02: u16 = 0_0 {
        ...
        DMA2TSEL: 0..4 = enum DMA2TSEL {
            ...
            DMA2TSEL_6 = 0b00110,
            /// DMA channel 2 transfer select 7:  TimerB (TB0CCR0.IFG)
            DMA2TSEL_7 = 0b00111,
            /// DMA channel 2 transfer select 8:  TimerB (TB0CCR2.IFG)
            DMA2TSEL_8 = 0b01000,
            /// DMA channel 2 transfer select 9:  UCA2RXIFG
            DMA2TSEL_9 = 0b01001,
            /// DMA channel 2 transfer select 10: UCA2TXIFG
            DMA2TSEL_10 = 0b01010,
            /// DMA channel 2 transfer select 11: UCB2RXIFG
            DMA2TSEL_11 = 0b01011,
            /// DMA channel 2 transfer select 12: UCB2TXIFG
            DMA2TSEL_12 = 0b01100,
            /// DMA channel 2 transfer select 13: Reserved
            DMA2TSEL_13 = 0b01101,
            /// DMA channel 2 transfer select 14: Reserved
            DMA2TSEL_14 = 0b01110,
            /// DMA channel 2 transfer select 15: Reserved
            DMA2TSEL_15 = 0b01111,
            ...
            DMA2TSEL_24 = 0b11000,
            /// DMA channel 2 transfer select 25: UCA3RXIFG
            DMA2TSEL_25 = 0b11001,
            /// DMA channel 2 transfer select 26: UCA3TXIFG
            DMA2TSEL_26 = 0b11010,
            /// DMA channel 2 transfer select 27: UCB3RXIFG
            DMA2TSEL_27 = 0b11011,
            /// DMA channel 2 transfer select 28: UCB3TXIFG
            DMA2TSEL_28 = 0b11100,
