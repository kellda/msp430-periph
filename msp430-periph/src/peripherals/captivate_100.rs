...
utils::periph! {
    ...
    rw CAPIE @ 0x00: u16 = 0_0 {
        ...
        CAPDTCTIEN: 1..1 = enum CAPDTCTIEN {
            /// Interrupt disabled
            CAPDTCTIEN_0 = 0b0,
            /// Interrupt enabled
            CAPDTCTIEN_1 = 0b1,
        ...
        CAPCNTRIEN: 3..3 = enum CAPCNTRIEN {
            /// Interrupt disabled
            CAPCNTRIEN_0 = 0b0,
            /// Interrupt enabled
            CAPCNTRIEN_1 = 0b1,
    ...
    rw CAPIFG @ 0x02: u16 = 0_0 {
        ...
        CAPDTCTIFG: 1..1 = enum CAPDTCTIFG {
        ...
        CAPCNTRIFG: 3..3 = enum CAPCNTRIFG {
            /// No interrupt pending
            CAPCNTRIFG_0 = 0b0,
            /// Interrupt pending
            CAPCNTRIFG_1 = 0b1,
