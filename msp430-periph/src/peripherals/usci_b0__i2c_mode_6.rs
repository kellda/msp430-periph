...
utils::periph! {
    ...
    rw UCB0CTL0 @ 0x01: u8 = 0_0 {
        /// USCI B0 Control Register 0
        UCB0CTL0: 0..7 = struct UCB0CTL0Field(u8);
    }
    /// USCI B0 Control Register 1
    rw UCB0CTL1 @ 0x00: u8 = 0_0 {
        /// USCI B0 Control Register 1
        UCB0CTL1: 0..7 = struct UCB0CTL1Field(u8);
    }
    /// USCI B0 Control Word Register 1
    rw UCB0CTLW1 @ 0x02: u16 = 0_0 {
    ...
    rw UCB0BRW @ 0x06: u16 = 0_0 {
        /// USCI B0 Baud Word Rate 0
        UCB0BRW: 0..15 = struct UCB0BRWField(u16);
    }
    /// USCI B0 Baud Rate 0
    rw UCB0BR0 @ 0x06: u8 = 0_0 {
        /// USCI B0 Baud Rate 0
        UCB0BR0: 0..7 = struct UCB0BR0Field(u8);
    }
    /// USCI B0 Baud Rate 1
    rw UCB0BR1 @ 0x07: u8 = 0_0 {
        /// USCI B0 Baud Rate 1
        UCB0BR1: 0..7 = struct UCB0BR1Field(u8);
    }
    /// USCI B0 Status Word Register
    rw UCB0STATW @ 0x08: u16 = 0_0 {
        /// USCI B0 Status Word Register
        UCB0STATW: 0..15 = struct UCB0STATWField(u16);
    }
    /// USCI B0 Status Register
    rw UCB0STATW__I2C @ 0x08: u16 = 0_0 {
        /// Bus Busy Flag
        UCB0STATW__I2C_UCBBUSY: 4 = struct UCB0STATW__I2C_UCBBUSY(bool);
        /// General Call address received Flag
        UCB0STATW__I2C_UCGC: 5 = struct UCB0STATW__I2C_UCGC(bool);
        /// SCL low
        UCB0STATW__I2C_UCSCLLOW: 6 = struct UCB0STATW__I2C_UCSCLLOW(bool);
        /// USCI Byte Counter Bit 0
        UCB0STATW__I2C_UCBCNT0: 8 = struct UCB0STATW__I2C_UCBCNT0(bool);
        /// USCI Byte Counter Bit 1
        UCB0STATW__I2C_UCBCNT1: 9 = struct UCB0STATW__I2C_UCBCNT1(bool);
        /// USCI Byte Counter Bit 2
        UCB0STATW__I2C_UCBCNT2: 10 = struct UCB0STATW__I2C_UCBCNT2(bool);
        /// USCI Byte Counter Bit 3
        UCB0STATW__I2C_UCBCNT3: 11 = struct UCB0STATW__I2C_UCBCNT3(bool);
        /// USCI Byte Counter Bit 4
        UCB0STATW__I2C_UCBCNT4: 12 = struct UCB0STATW__I2C_UCBCNT4(bool);
        /// USCI Byte Counter Bit 5
        UCB0STATW__I2C_UCBCNT5: 13 = struct UCB0STATW__I2C_UCBCNT5(bool);
        /// USCI Byte Counter Bit 6
        UCB0STATW__I2C_UCBCNT6: 14 = struct UCB0STATW__I2C_UCBCNT6(bool);
        /// USCI Byte Counter Bit 7
        UCB0STATW__I2C_UCBCNT7: 15 = struct UCB0STATW__I2C_UCBCNT7(bool);
    }
    /// USCI B0 Status Register
    rw UCB0STAT__I2C @ 0x08: u8 = 0_0 {
        /// Bus Busy Flag
        UCB0STAT__I2C_UCBBUSY: 4 = struct UCB0STAT__I2C_UCBBUSY(bool);
        /// General Call address received Flag
        UCB0STAT__I2C_UCGC: 5 = struct UCB0STAT__I2C_UCGC(bool);
        /// SCL low
        UCB0STAT__I2C_UCSCLLOW: 6 = struct UCB0STAT__I2C_UCSCLLOW(bool);
    }
    /// USCI B0 Byte Counter Register
    rw UCB0BCNT__I2C @ 0x09: u8 = 0_0 {
        /// USCI Byte Counter Bit 0
        UCB0BCNT__I2C_UCBCNT0: 0 = struct UCB0BCNT__I2C_UCBCNT0(bool);
        /// USCI Byte Counter Bit 1
        UCB0BCNT__I2C_UCBCNT1: 1 = struct UCB0BCNT__I2C_UCBCNT1(bool);
        /// USCI Byte Counter Bit 2
        UCB0BCNT__I2C_UCBCNT2: 2 = struct UCB0BCNT__I2C_UCBCNT2(bool);
        /// USCI Byte Counter Bit 3
        UCB0BCNT__I2C_UCBCNT3: 3 = struct UCB0BCNT__I2C_UCBCNT3(bool);
        /// USCI Byte Counter Bit 4
        UCB0BCNT__I2C_UCBCNT4: 4 = struct UCB0BCNT__I2C_UCBCNT4(bool);
        /// USCI Byte Counter Bit 5
        UCB0BCNT__I2C_UCBCNT5: 5 = struct UCB0BCNT__I2C_UCBCNT5(bool);
        /// USCI Byte Counter Bit 6
        UCB0BCNT__I2C_UCBCNT6: 6 = struct UCB0BCNT__I2C_UCBCNT6(bool);
        /// USCI Byte Counter Bit 7
        UCB0BCNT__I2C_UCBCNT7: 7 = struct UCB0BCNT__I2C_UCBCNT7(bool);
    }
    /// USCI B0 Byte Counter Threshold Register
    rw UCB0TBCNT @ 0x0a: u16 = 0_0 {
        /// USCI B0 Byte Counter Threshold Register
        UCB0TBCNT: 0..15 = struct UCB0TBCNTField(u16);
    }
    /// USCI B0 Receive Buffer
    rw UCB0RXBUF @ 0x0c: u16 = 0_0 {
        /// USCI B0 Receive Buffer
        UCB0RXBUF: 0..15 = struct UCB0RXBUFField(u16);
    }
    /// USCI B0 Transmit Buffer
    rw UCB0TXBUF @ 0x0e: u16 = 0_0 {
        /// USCI B0 Transmit Buffer
        UCB0TXBUF: 0..15 = struct UCB0TXBUFField(u16);
    }
    /// USCI B0 I2C Own Address 0
    rw UCB0I2COA0 @ 0x14: u16 = 0_0 {
        /// I2C Own Address Bit 0
        UCB0I2COA0_UCOA0: 0 = struct UCB0I2COA0_UCOA0(bool);
        /// I2C Own Address Bit 1
        UCB0I2COA0_UCOA1: 1 = struct UCB0I2COA0_UCOA1(bool);
        /// I2C Own Address Bit 2
        UCB0I2COA0_UCOA2: 2 = struct UCB0I2COA0_UCOA2(bool);
        /// I2C Own Address Bit 3
        UCB0I2COA0_UCOA3: 3 = struct UCB0I2COA0_UCOA3(bool);
        /// I2C Own Address Bit 4
        UCB0I2COA0_UCOA4: 4 = struct UCB0I2COA0_UCOA4(bool);
        /// I2C Own Address Bit 5
        UCB0I2COA0_UCOA5: 5 = struct UCB0I2COA0_UCOA5(bool);
        /// I2C Own Address Bit 6
        UCB0I2COA0_UCOA6: 6 = struct UCB0I2COA0_UCOA6(bool);
        /// I2C Own Address Bit 7
        UCB0I2COA0_UCOA7: 7 = struct UCB0I2COA0_UCOA7(bool);
        /// I2C Own Address Bit 8
        UCB0I2COA0_UCOA8: 8 = struct UCB0I2COA0_UCOA8(bool);
        /// I2C Own Address Bit 9
        UCB0I2COA0_UCOA9: 9 = struct UCB0I2COA0_UCOA9(bool);
        /// I2C Own Address enable
        UCB0I2COA0_UCOAEN: 10 = struct UCB0I2COA0_UCOAEN(bool);
        /// I2C General Call enable
        UCGCEN: 15 = struct UCGCEN(bool);
    }
    /// USCI B0 I2C Own Address 1
    rw UCB0I2COA1 @ 0x16: u16 = 0_0 {
        /// I2C Own Address Bit 0
        UCB0I2COA1_UCOA0: 0 = struct UCB0I2COA1_UCOA0(bool);
        /// I2C Own Address Bit 1
        UCB0I2COA1_UCOA1: 1 = struct UCB0I2COA1_UCOA1(bool);
        /// I2C Own Address Bit 2
        UCB0I2COA1_UCOA2: 2 = struct UCB0I2COA1_UCOA2(bool);
        /// I2C Own Address Bit 3
        UCB0I2COA1_UCOA3: 3 = struct UCB0I2COA1_UCOA3(bool);
        /// I2C Own Address Bit 4
        UCB0I2COA1_UCOA4: 4 = struct UCB0I2COA1_UCOA4(bool);
        /// I2C Own Address Bit 5
        UCB0I2COA1_UCOA5: 5 = struct UCB0I2COA1_UCOA5(bool);
        /// I2C Own Address Bit 6
        UCB0I2COA1_UCOA6: 6 = struct UCB0I2COA1_UCOA6(bool);
        /// I2C Own Address Bit 7
        UCB0I2COA1_UCOA7: 7 = struct UCB0I2COA1_UCOA7(bool);
        /// I2C Own Address Bit 8
        UCB0I2COA1_UCOA8: 8 = struct UCB0I2COA1_UCOA8(bool);
        /// I2C Own Address Bit 9
        UCB0I2COA1_UCOA9: 9 = struct UCB0I2COA1_UCOA9(bool);
        /// I2C Own Address enable
        UCB0I2COA1_UCOAEN: 10 = struct UCB0I2COA1_UCOAEN(bool);
    }
    /// USCI B0 I2C Own Address 2
    rw UCB0I2COA2 @ 0x18: u16 = 0_0 {
        /// I2C Own Address Bit 0
        UCB0I2COA2_UCOA0: 0 = struct UCB0I2COA2_UCOA0(bool);
        /// I2C Own Address Bit 1
        UCB0I2COA2_UCOA1: 1 = struct UCB0I2COA2_UCOA1(bool);
        /// I2C Own Address Bit 2
        UCB0I2COA2_UCOA2: 2 = struct UCB0I2COA2_UCOA2(bool);
        /// I2C Own Address Bit 3
        UCB0I2COA2_UCOA3: 3 = struct UCB0I2COA2_UCOA3(bool);
        /// I2C Own Address Bit 4
        UCB0I2COA2_UCOA4: 4 = struct UCB0I2COA2_UCOA4(bool);
        /// I2C Own Address Bit 5
        UCB0I2COA2_UCOA5: 5 = struct UCB0I2COA2_UCOA5(bool);
        /// I2C Own Address Bit 6
        UCB0I2COA2_UCOA6: 6 = struct UCB0I2COA2_UCOA6(bool);
        /// I2C Own Address Bit 7
        UCB0I2COA2_UCOA7: 7 = struct UCB0I2COA2_UCOA7(bool);
        /// I2C Own Address Bit 8
        UCB0I2COA2_UCOA8: 8 = struct UCB0I2COA2_UCOA8(bool);
        /// I2C Own Address Bit 9
        UCB0I2COA2_UCOA9: 9 = struct UCB0I2COA2_UCOA9(bool);
        /// I2C Own Address enable
        UCB0I2COA2_UCOAEN: 10 = struct UCB0I2COA2_UCOAEN(bool);
    }
    /// USCI B0 I2C Own Address 3
    rw UCB0I2COA3 @ 0x1a: u16 = 0_0 {
        /// I2C Own Address Bit 0
        UCB0I2COA3_UCOA0: 0 = struct UCB0I2COA3_UCOA0(bool);
        /// I2C Own Address Bit 1
        UCB0I2COA3_UCOA1: 1 = struct UCB0I2COA3_UCOA1(bool);
        /// I2C Own Address Bit 2
        UCB0I2COA3_UCOA2: 2 = struct UCB0I2COA3_UCOA2(bool);
        /// I2C Own Address Bit 3
        UCB0I2COA3_UCOA3: 3 = struct UCB0I2COA3_UCOA3(bool);
        /// I2C Own Address Bit 4
        UCB0I2COA3_UCOA4: 4 = struct UCB0I2COA3_UCOA4(bool);
        /// I2C Own Address Bit 5
        UCB0I2COA3_UCOA5: 5 = struct UCB0I2COA3_UCOA5(bool);
        /// I2C Own Address Bit 6
        UCB0I2COA3_UCOA6: 6 = struct UCB0I2COA3_UCOA6(bool);
        /// I2C Own Address Bit 7
        UCB0I2COA3_UCOA7: 7 = struct UCB0I2COA3_UCOA7(bool);
        /// I2C Own Address Bit 8
        UCB0I2COA3_UCOA8: 8 = struct UCB0I2COA3_UCOA8(bool);
        /// I2C Own Address Bit 9
        UCB0I2COA3_UCOA9: 9 = struct UCB0I2COA3_UCOA9(bool);
        /// I2C Own Address enable
        UCB0I2COA3_UCOAEN: 10 = struct UCB0I2COA3_UCOAEN(bool);
    }
    /// USCI B0 Received Address Register
    rw UCB0ADDRX @ 0x1c: u16 = 0_0 {
    ...
    rw UCB0IE @ 0x2a: u16 = 0_0 {
        /// USCI B0 Interrupt Enable Register
        UCB0IE: 0..15 = struct UCB0IEField(u16);
    }
    /// USCI B0 Interrupt Flags Register
    rw UCB0IFG @ 0x2c: u16 = 0_0 {
        /// USCI B0 Interrupt Flags Register
        UCB0IFG: 0..15 = struct UCB0IFGField(u16);
    }
    /// USCI B0 Interrupt Enable Register
    rw UCB0IE__I2C @ 0x2a: u16 = 0_0 {
    ...
    rw UCB0IV @ 0x2e: u16 = 0_0 {
        /// USCI B0 Interrupt Vector Register
        UCB0IV: 0..15 = struct UCB0IVField(u16);
    }
}
