...
utils::periph! {
    ...
    rw TA1CCTL0 @ 0x02: u16 = 0_0 {
        ...
        TA1CCTL0_CCIFG: 0 = enum TA1CCTL0_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA1CCTL0_COV: 1 = enum TA1CCTL0_COV {
        ...
        /// Output
        TA1CCTL0_OUT: 2 = enum TA1CCTL0_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        TA1CCTL0_CCIE: 4 = enum TA1CCTL0_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA1CCTL0_CAP: 8 = enum TA1CCTL0_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        TA1CCTL0_SCS: 11 = enum TA1CCTL0_SCS {
    ...
    rw TA1CCTL1 @ 0x04: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA1CCTL1_CCIFG: 0 = enum TA1CCTL1_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA1CCTL1_COV: 1 = enum TA1CCTL1_COV {
            /// No capture overflow occurred
            COV_0 = 0b0,
            /// Capture overflow occurred
            COV_1 = 0b1,
        ...
        /// Output
        TA1CCTL1_OUT: 2 = enum TA1CCTL1_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        /// Capture/compare interrupt enable
        TA1CCTL1_CCIE: 4 = enum TA1CCTL1_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA1CCTL1_CAP: 8 = enum TA1CCTL1_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        /// Synchronize capture source
        TA1CCTL1_SCS: 11 = enum TA1CCTL1_SCS {
            /// Asynchronous capture
            ASYNC = 0b0,
            /// Synchronous capture
            SYNC = 0b1,
    ...
    rw TA1CCTL2 @ 0x06: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA1CCTL2_CCIFG: 0 = enum TA1CCTL2_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA1CCTL2_COV: 1 = enum TA1CCTL2_COV {
            /// No capture overflow occurred
            COV_0 = 0b0,
            /// Capture overflow occurred
            COV_1 = 0b1,
        ...
        /// Output
        TA1CCTL2_OUT: 2 = enum TA1CCTL2_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        /// Capture/compare interrupt enable
        TA1CCTL2_CCIE: 4 = enum TA1CCTL2_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA1CCTL2_CAP: 8 = enum TA1CCTL2_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        /// Synchronize capture source
        TA1CCTL2_SCS: 11 = enum TA1CCTL2_SCS {
            /// Asynchronous capture
            ASYNC = 0b0,
            /// Synchronous capture
            SYNC = 0b1,
    ...
    rw TA1CCTL3 @ 0x08: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA1CCTL3_CCIFG: 0 = enum TA1CCTL3_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA1CCTL3_COV: 1 = enum TA1CCTL3_COV {
            /// No capture overflow occurred
            COV_0 = 0b0,
            /// Capture overflow occurred
            COV_1 = 0b1,
        ...
        /// Output
        TA1CCTL3_OUT: 2 = enum TA1CCTL3_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        /// Capture/compare interrupt enable
        TA1CCTL3_CCIE: 4 = enum TA1CCTL3_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA1CCTL3_CAP: 8 = enum TA1CCTL3_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        /// Synchronize capture source
        TA1CCTL3_SCS: 11 = enum TA1CCTL3_SCS {
            /// Asynchronous capture
            ASYNC = 0b0,
            /// Synchronous capture
            SYNC = 0b1,
    ...
    rw TA1CCTL4 @ 0x0a: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA1CCTL4_CCIFG: 0 = enum TA1CCTL4_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA1CCTL4_COV: 1 = enum TA1CCTL4_COV {
            /// No capture overflow occurred
            COV_0 = 0b0,
            /// Capture overflow occurred
            COV_1 = 0b1,
        ...
        /// Output
        TA1CCTL4_OUT: 2 = enum TA1CCTL4_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        /// Capture/compare interrupt enable
        TA1CCTL4_CCIE: 4 = enum TA1CCTL4_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA1CCTL4_CAP: 8 = enum TA1CCTL4_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        /// Synchronize capture source
        TA1CCTL4_SCS: 11 = enum TA1CCTL4_SCS {
            /// Asynchronous capture
            ASYNC = 0b0,
            /// Synchronous capture
            SYNC = 0b1,
    ...
    rw TA1CCTL5 @ 0x0c: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA1CCTL5_CCIFG: 0 = enum TA1CCTL5_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA1CCTL5_COV: 1 = enum TA1CCTL5_COV {
            /// No capture overflow occurred
            COV_0 = 0b0,
            /// Capture overflow occurred
            COV_1 = 0b1,
        ...
        /// Output
        TA1CCTL5_OUT: 2 = enum TA1CCTL5_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        /// Capture/compare interrupt enable
        TA1CCTL5_CCIE: 4 = enum TA1CCTL5_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA1CCTL5_CAP: 8 = enum TA1CCTL5_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        /// Synchronize capture source
        TA1CCTL5_SCS: 11 = enum TA1CCTL5_SCS {
            /// Asynchronous capture
            ASYNC = 0b0,
            /// Synchronous capture
            SYNC = 0b1,
    ...
    rw TA1CCTL6 @ 0x0e: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA1CCTL6_CCIFG: 0 = enum TA1CCTL6_CCIFG {
            /// No interrupt pending
            CCIFG_0 = 0b0,
            /// Interrupt pending
            CCIFG_1 = 0b1,
        ...
        /// Capture overflow
        TA1CCTL6_COV: 1 = enum TA1CCTL6_COV {
            /// No capture overflow occurred
            COV_0 = 0b0,
            /// Capture overflow occurred
            COV_1 = 0b1,
        ...
        /// Output
        TA1CCTL6_OUT: 2 = enum TA1CCTL6_OUT {
            /// Output low
            LOW = 0b0,
            /// Output high
            HIGH = 0b1,
        ...
        /// Capture/compare interrupt enable
        TA1CCTL6_CCIE: 4 = enum TA1CCTL6_CCIE {
            /// Interrupt disabled
            CCIE_0 = 0b0,
            /// Interrupt enabled
            CCIE_1 = 0b1,
        ...
        /// Capture mode
        TA1CCTL6_CAP: 8 = enum TA1CCTL6_CAP {
            /// Compare mode
            COMPARE = 0b0,
            /// Capture mode
            CAPTURE = 0b1,
        ...
        /// Synchronize capture source
        TA1CCTL6_SCS: 11 = enum TA1CCTL6_SCS {
            /// Asynchronous capture
            ASYNC = 0b0,
            /// Synchronous capture
            SYNC = 0b1,
