...
utils::periph! {
    ...
    rw UCB0CTLW0 @ 0x00: u16 = 0_0 {
        /// USCI B0 Control Word Register 0
        UCB0CTLW0: 0..15 = struct UCB0CTLW0Field(u16);
    }
    ...
    rw UCB0RXBUF @ 0x0c: u8 = 0_0 {
        /// USCI B0 Receive Buffer
        UCB0RXBUF: 0..7 = struct UCB0RXBUFField(u8);
    }
    /// USCI B0 Transmit Buffer
    rw UCB0TXBUF @ 0x0e: u8 = 0_0 {
        /// USCI B0 Transmit Buffer
        UCB0TXBUF: 0..7 = struct UCB0TXBUFField(u8);
    }
    /// USCI B0 I2C Own Address
    rw UCB0I2COA @ 0x10: u16 = 0_0 {
        /// I2C Own Address 0
    ...
    rw UCB0ICTL @ 0x1c: u16 = 0_0 {
        /// USCI B0 Interrupt Enable Register
        UCB0ICTL: 0..15 = struct UCB0ICTLField(u16);
    }
    /// USCI B0 Interrupt Enable Register
    rw UCB0IE @ 0x1c: u8 = 0_0 {
