...
utils::periph! {
    ...
    rw DMACTL0 @ 0x00: u16 = 0_0 {
        ...
        DMA0TSEL: 0..3 = enum DMA0TSEL {
            ...
            DMA0TSEL_2 = 0b0010,
            /// DMA channel 0 transfer select 3:  USCIA receive
            DMA0TSEL_3 = 0b0011,
            /// DMA channel 0 transfer select 4:  USCIA transmit
            DMA0TSEL_4 = 0b0100,
            ...
            DMA0TSEL_11 = 0b1011,
            /// DMA channel 0 transfer select 12: USCIB receive
            DMA0TSEL_12 = 0b1100,
            /// DMA channel 0 transfer select 13: USCIB transmit
            DMA0TSEL_13 = 0b1101,
        ...
        DMA1TSEL: 4..7 = enum DMA1TSEL {
            ...
            DMA1TSEL_2 = 0b0010,
            /// DMA channel 1 transfer select 3:  USCIA receive
            DMA1TSEL_3 = 0b0011,
            /// DMA channel 1 transfer select 4:  USCIA transmit
            DMA1TSEL_4 = 0b0100,
            ...
            DMA1TSEL_8 = 0b1000,
            /// DMA channel 1 transfer select 9:  UART1 receive
            DMA1TSEL_9 = 0b1001,
            /// DMA channel 1 transfer select 10: UART1 transmit
            DMA1TSEL_10 = 0b1010,
            /// DMA channel 1 transfer select 11: Multiplier ready
            DMA1TSEL_11 = 0b1011,
            /// DMA channel 1 transfer select 12: USCIB receive
            DMA1TSEL_12 = 0b1100,
            /// DMA channel 1 transfer select 13: USCIB transmit
            DMA1TSEL_13 = 0b1101,
        ...
        DMA2TSEL: 8..11 = enum DMA2TSEL {
            ...
            DMA2TSEL_2 = 0b0010,
            /// DMA channel 2 transfer select 3:  USCIA receive
            DMA2TSEL_3 = 0b0011,
            /// DMA channel 2 transfer select 4:  USCIA transmit
            DMA2TSEL_4 = 0b0100,
            ...
            DMA2TSEL_8 = 0b1000,
            /// DMA channel 2 transfer select 9:  UART1 receive
            DMA2TSEL_9 = 0b1001,
            /// DMA channel 2 transfer select 10: UART1 transmit
            DMA2TSEL_10 = 0b1010,
            /// DMA channel 2 transfer select 11: Multiplier ready
            DMA2TSEL_11 = 0b1011,
            /// DMA channel 2 transfer select 12: USCIB receive
            DMA2TSEL_12 = 0b1100,
            /// DMA channel 2 transfer select 13: USCIB transmit
            DMA2TSEL_13 = 0b1101,
