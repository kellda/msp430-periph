...
utils::periph! {
    ...
    rw P5IV @ 0x0e: u16 = 0_0 {
        /// Port 5 Interrupt Vector Word
        P5IV: 0..15 = struct P5IVField(u16);
    }
    /// Port 5 Interrupt Edge Select
    rw P5IES @ 0x18: u8 = 0_0 {
        /// P5IES0
        P5IES0: 0 = struct P5IES0(bool);
        /// P5IES1
        P5IES1: 1 = struct P5IES1(bool);
        /// P5IES2
        P5IES2: 2 = struct P5IES2(bool);
        /// P5IES3
        P5IES3: 3 = struct P5IES3(bool);
        /// P5IES4
        P5IES4: 4 = struct P5IES4(bool);
        /// P5IES5
        P5IES5: 5 = struct P5IES5(bool);
        /// P5IES6
        P5IES6: 6 = struct P5IES6(bool);
        /// P5IES7
        P5IES7: 7 = struct P5IES7(bool);
    }
    /// Port 5 Interrupt Enable
    rw P5IE @ 0x1a: u8 = 0_0 {
        /// P5IE0
        P5IE0: 0 = struct P5IE0(bool);
        /// P5IE1
        P5IE1: 1 = struct P5IE1(bool);
        /// P5IE2
        P5IE2: 2 = struct P5IE2(bool);
        /// P5IE3
        P5IE3: 3 = struct P5IE3(bool);
        /// P5IE4
        P5IE4: 4 = struct P5IE4(bool);
        /// P5IE5
        P5IE5: 5 = struct P5IE5(bool);
        /// P5IE6
        P5IE6: 6 = struct P5IE6(bool);
        /// P5IE7
        P5IE7: 7 = struct P5IE7(bool);
    }
    /// Port 5 Interrupt Flag
    rw P5IFG @ 0x1c: u8 = 0_0 {
        /// P5IFG0
        P5IFG0: 0 = struct P5IFG0(bool);
        /// P5IFG1
        P5IFG1: 1 = struct P5IFG1(bool);
        /// P5IFG2
        P5IFG2: 2 = struct P5IFG2(bool);
        /// P5IFG3
        P5IFG3: 3 = struct P5IFG3(bool);
        /// P5IFG4
        P5IFG4: 4 = struct P5IFG4(bool);
        /// P5IFG5
        P5IFG5: 5 = struct P5IFG5(bool);
        /// P5IFG6
        P5IFG6: 6 = struct P5IFG6(bool);
        /// P5IFG7
        P5IFG7: 7 = struct P5IFG7(bool);
    }
    /// Port 6 Input
    rw P6IN @ 0x01: u8 = 0_0 {
        /// P6IN0
    ...
    rw P6IV @ 0x1e: u16 = 0_0 {
        /// Port 6 Interrupt Vector Word
        P6IV: 0..15 = struct P6IVField(u16);
    }
    /// Port 6 Interrupt Edge Select
    rw P6IES @ 0x19: u8 = 0_0 {
        /// P6IES0
        P6IES0: 0 = struct P6IES0(bool);
        /// P6IES1
        P6IES1: 1 = struct P6IES1(bool);
        /// P6IES2
        P6IES2: 2 = struct P6IES2(bool);
        /// P6IES3
        P6IES3: 3 = struct P6IES3(bool);
        /// P6IES4
        P6IES4: 4 = struct P6IES4(bool);
        /// P6IES5
        P6IES5: 5 = struct P6IES5(bool);
        /// P6IES6
        P6IES6: 6 = struct P6IES6(bool);
        /// P6IES7
        P6IES7: 7 = struct P6IES7(bool);
    }
    /// Port 6 Interrupt Enable
    rw P6IE @ 0x1b: u8 = 0_0 {
        /// P6IE0
        P6IE0: 0 = struct P6IE0(bool);
        /// P6IE1
        P6IE1: 1 = struct P6IE1(bool);
        /// P6IE2
        P6IE2: 2 = struct P6IE2(bool);
        /// P6IE3
        P6IE3: 3 = struct P6IE3(bool);
        /// P6IE4
        P6IE4: 4 = struct P6IE4(bool);
        /// P6IE5
        P6IE5: 5 = struct P6IE5(bool);
        /// P6IE6
        P6IE6: 6 = struct P6IE6(bool);
        /// P6IE7
        P6IE7: 7 = struct P6IE7(bool);
    }
    /// Port 6 Interrupt Flag
    rw P6IFG @ 0x1d: u8 = 0_0 {
        /// P6IFG0
        P6IFG0: 0 = struct P6IFG0(bool);
        /// P6IFG1
        P6IFG1: 1 = struct P6IFG1(bool);
        /// P6IFG2
        P6IFG2: 2 = struct P6IFG2(bool);
        /// P6IFG3
        P6IFG3: 3 = struct P6IFG3(bool);
        /// P6IFG4
        P6IFG4: 4 = struct P6IFG4(bool);
        /// P6IFG5
        P6IFG5: 5 = struct P6IFG5(bool);
        /// P6IFG6
        P6IFG6: 6 = struct P6IFG6(bool);
        /// P6IFG7
        P6IFG7: 7 = struct P6IFG7(bool);
    }
}
