...
utils::periph! {
    ...
    rw SYSCNF @ 0x10: u16 = 0_0 {
        /// SYS - SVM output enable
        SVMOE: 2 = struct SVMOE(bool);
        /// SYS - SVM based Ports off flag
        SVMPO: 3 = struct SVMPO(bool);
        /// SYS - Incoming JTAG Mailbox 0 Flag
        SVMPD: 4 = struct SVMPD(bool);
        /// SYS - SVM based port disable
        SVMEN: 5 = struct SVMEN(bool);
        /// SYS - Write lock enable for configuration RAM
        RAMLCK0: 8 = struct RAMLCK0(bool);
        /// SYS - Write lock enable for applicationon RAM
        RAMLCK1: 9 = struct RAMLCK1(bool);
    }
