...
utils::periph! {
    ...
    rw MEMCTL @ 0x06: u16 = 0_0 {
        ...
        LRM: 1 = struct LRM(bool);
        /// LCD_C Clear LCD blinking memory
        LRBM: 2 = struct LRBM(bool);
    }
    ...
    rw CPCTL @ 0x12: u16 = 0_0 {
        ...
        PDIS0: 0 = struct PDIS0(bool);
        /// LCD charge pump disable
        PDIS1: 1 = struct PDIS1(bool);
        /// LCD charge pump disable
        PDIS2: 2 = struct PDIS2(bool);
        /// LCD charge pump disable
        PDIS3: 3 = struct PDIS3(bool);
        /// LCD charge pump disable
        PDIS4: 4 = struct PDIS4(bool);
        /// LCD charge pump disable
        PDIS5: 5 = struct PDIS5(bool);
        /// LCD charge pump disable
        PDIS6: 6 = struct PDIS6(bool);
        /// LCD charge pump disable
        PDIS7: 7 = struct PDIS7(bool);
        /// LCD charge pump clock synchronization
        PCLKSYNC: 15 = struct PCLKSYNC(bool);
    }
    ...
    rw M41 @ 0x48: u8 = 0_0 {
        /// LCD Memory 41
        M41: 0..7 = struct M41Field(u8);
    }
    /// LCD Memory 42
    rw M42 @ 0x49: u8 = 0_0 {
        /// LCD Memory 42
        M42: 0..7 = struct M42Field(u8);
    }
    /// LCD Memory 43
    rw M43 @ 0x4a: u8 = 0_0 {
        /// LCD Memory 43
        M43: 0..7 = struct M43Field(u8);
    }
