...
utils::periph! {
    ...
    /// LCD Memory 41
    rw LCDM41 @ 0x48: u8 = 0_0 {
        /// LCD Memory 41
        LCDM41: 0..7 = struct LCDM41Field(u8);
    }
    /// LCD Memory 42
    rw LCDM42 @ 0x49: u8 = 0_0 {
        /// LCD Memory 42
        LCDM42: 0..7 = struct LCDM42Field(u8);
    }
    /// LCD Memory 43
    rw LCDM43 @ 0x4a: u8 = 0_0 {
        /// LCD Memory 43
        LCDM43: 0..7 = struct LCDM43Field(u8);
    }
