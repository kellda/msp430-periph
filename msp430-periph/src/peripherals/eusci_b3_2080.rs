...
utils::periph! {
    ...
    rw UCB3CTLW0 @ 0x00: u16 = 0_0 {
        ...
        UCB3CTLW0_UCSWRST: 0 = enum UCB3CTLW0_UCSWRST {
        ...
        UCB3CTLW0_UCSYNC: 8 = enum UCB3CTLW0_UCSYNC {
            /// Asynchronous mode
            ASYNC = 0b0,
            /// Synchronous mode
            SYNC = 0b1,
        ...
        /// Master mode select
        UCB3CTLW0_UCMST: 11 = enum UCB3CTLW0_UCMST {
            /// Slave mode
            SLAVE = 0b0,
            /// Master mode
            MASTER = 0b1,
    ...
    rw UCB3CTLW0_SPI @ 0x00: u16 = 0_0 {
        /// Software reset enable
        UCB3CTLW0_SPI_UCSWRST: 0 = enum UCB3CTLW0_SPI_UCSWRST {
            /// Disabled. eUSCI_B reset released for operation
            DISABLE = 0b0,
            /// Enabled. eUSCI_B logic held in reset state
            ENABLE = 0b1,
        ...
        /// Synchronous mode enable
        UCB3CTLW0_SPI_UCSYNC: 8 = enum UCB3CTLW0_SPI_UCSYNC {
            /// Asynchronous mode
            ASYNC = 0b0,
            /// Synchronous mode
            SYNC = 0b1,
        ...
        /// Master mode select
        UCB3CTLW0_SPI_UCMST: 11 = enum UCB3CTLW0_SPI_UCMST {
            /// Slave mode
            SLAVE = 0b0,
            /// Master mode
            MASTER = 0b1,
    ...
    rw UCB3I2COA0 @ 0x14: u16 = 0_0 {
        ...
        UCB3I2COA0_UCOAEN: 10 = enum UCB3I2COA0_UCOAEN {
    ...
    rw UCB3I2COA1 @ 0x16: u16 = 0_0 {
        ...
        /// Own Address enable register
        UCB3I2COA1_UCOAEN: 10 = enum UCB3I2COA1_UCOAEN {
    ...
    rw UCB3I2COA2 @ 0x18: u16 = 0_0 {
        ...
        /// Own Address enable register
        UCB3I2COA2_UCOAEN: 10 = enum UCB3I2COA2_UCOAEN {
    ...
    rw UCB3I2COA3 @ 0x1a: u16 = 0_0 {
        ...
        /// Own Address enable register
        UCB3I2COA3_UCOAEN: 10 = enum UCB3I2COA3_UCOAEN {
