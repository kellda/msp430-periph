...
utils::periph! {
    ...
    rw UCB3CTLW0 @ 0x00: u16 = 0_0 {
        /// Software reset enable
        UCB3CTLW0_UCSWRST: 0..0 = enum UCB3CTLW0_UCSWRST {
        ...
        UCB3CTLW0_UCSSEL: 6..7 = enum UCB3CTLW0_UCSSEL {
            /// UCLKI
            UCLKI = 0b00,
            /// ACLK
            ACLK = 0b01,
        ...
        UCB3CTLW0_UCSYNC: 8..8 = enum UCB3CTLW0_UCSYNC {
            /// Asynchronous mode
            ASYNC = 0b0,
            /// Synchronous mode
            SYNC = 0b1,
        ...
        /// eUSCI_B mode
        UCB3CTLW0_UCMODE: 9..10 = enum UCB3CTLW0_UCMODE {
            /// 3-pin SPI
            UCMODE_0 = 0b00,
        ...
        /// Master mode select
        UCB3CTLW0_UCMST: 11..11 = enum UCB3CTLW0_UCMST {
            /// Slave mode
            SLAVE = 0b0,
            /// Master mode
            MASTER = 0b1,
    ...
    /// eUSCI_Bx Control Word Register 0
    rw UCB3CTLW0_SPI @ 0x00: u16 = 0_0 {
        /// Software reset enable
        UCB3CTLW0_SPI_UCSWRST: 0..0 = enum UCB3CTLW0_SPI_UCSWRST {
            /// Disabled. eUSCI_B reset released for operation
            DISABLE = 0b0,
            /// Enabled. eUSCI_B logic held in reset state
            ENABLE = 0b1,
        ...
        /// eUSCI_B clock source select
        UCB3CTLW0_SPI_UCSSEL: 6..7 = enum UCB3CTLW0_SPI_UCSSEL {
            /// Reserved
            UCSSEL_0 = 0b00,
            /// ACLK
            ACLK = 0b01,
        ...
        /// Synchronous mode enable
        UCB3CTLW0_SPI_UCSYNC: 8..8 = enum UCB3CTLW0_SPI_UCSYNC {
            /// Asynchronous mode
            ASYNC = 0b0,
            /// Synchronous mode
            SYNC = 0b1,
        ...
        /// eUSCI mode
        UCB3CTLW0_SPI_UCMODE: 9..10 = enum UCB3CTLW0_SPI_UCMODE {
            /// 3-pin SPI
            UCMODE_0 = 0b00,
        ...
        /// Master mode select
        UCB3CTLW0_SPI_UCMST: 11..11 = enum UCB3CTLW0_SPI_UCMST {
            /// Slave mode
            SLAVE = 0b0,
            /// Master mode
            MASTER = 0b1,
    ...
    rw UCB3BRW @ 0x06: u16 = 0_0 {
        /// eUSCI_Bx Baud Rate Control Word Register
        UCB3BRW: 0..15 = struct UCB3BRWField(u16);
    }
    /// eUSCI_Bx Bit Rate Control Register 1
    rw UCB3BRW_SPI @ 0x06: u16 = 0_0 {
        /// eUSCI_Bx Bit Rate Control Register 1
        UCB3BRW_SPI: 0..15 = struct UCB3BRW_SPIField(u16);
    }
    /// eUSCI_Bx Status Register
    r UCB3STATW @ 0x08: u16 = 0_0 {
        /// Bus busy
    ...
    rw UCB3TBCNT @ 0x0a: u16 = 0_0 {
        /// Byte counter threshold value
        UCTBCNT: 0..7 = struct UCTBCNT(u16);
    }
    /// eUSCI_Bx Receive Buffer Register
    r UCB3RXBUF @ 0x0c: u16 = 0_0 {
        /// Receive data buffer
        UCB3RXBUF_UCRXBUF: 0..7 = struct UCB3RXBUF_UCRXBUF(u16);
    }
    /// eUSCI_Bx Receive Buffer Register
    r UCB3RXBUF_SPI @ 0x0c: u16 = 0_0 {
        /// Receive data buffer
        UCB3RXBUF_SPI_UCRXBUF: 0..7 = struct UCB3RXBUF_SPI_UCRXBUF(u16);
    }
    /// eUSCI_Bx Transmit Buffer Register
    rw UCB3TXBUF @ 0x0e: u16 = 0_0 {
        /// Transmit data buffer
        UCB3TXBUF_UCTXBUF: 0..7 = struct UCB3TXBUF_UCTXBUF(u16);
    }
    /// eUSCI_Bx Transmit Buffer Register
    rw UCB3TXBUF_SPI @ 0x0e: u16 = 0_0 {
        /// Transmit data buffer
        UCB3TXBUF_SPI_UCTXBUF: 0..7 = struct UCB3TXBUF_SPI_UCTXBUF(u16);
    }
    /// eUSCI_Bx I2C Own Address 0 Register
    rw UCB3I2COA0 @ 0x14: u16 = 0_0 {
        /// I2C own address
        I2COA0: 0..9 = struct I2COA0(u16);
        /// Own Address enable register
        UCB3I2COA0_UCOAEN: 10..10 = enum UCB3I2COA0_UCOAEN {
    ...
    rw UCB3I2COA1 @ 0x16: u16 = 0_0 {
        /// I2C own address
        I2COA1: 0..9 = struct I2COA1(u16);
        /// Own Address enable register
        UCB3I2COA1_UCOAEN: 10..10 = enum UCB3I2COA1_UCOAEN {
    ...
    rw UCB3I2COA2 @ 0x18: u16 = 0_0 {
        /// I2C own address
        I2COA2: 0..9 = struct I2COA2(u16);
        /// Own Address enable register
        UCB3I2COA2_UCOAEN: 10..10 = enum UCB3I2COA2_UCOAEN {
    ...
    rw UCB3I2COA3 @ 0x1a: u16 = 0_0 {
        /// I2C own address
        I2COA3: 0..9 = struct I2COA3(u16);
        /// Own Address enable register
        UCB3I2COA3_UCOAEN: 10..10 = enum UCB3I2COA3_UCOAEN {
    ...
    r UCB3IV @ 0x2e: u16 = 0_0 {
        /// eUSCI_B interrupt vector value
        UCB3IV_UCIV: 0..15 = enum UCB3IV_UCIV {
            /// No interrupt pending
    ...
    /// eUSCI_Bx Interrupt Vector Register
    r UCB3IV_SPI @ 0x2e: u16 = 0_0 {
        /// eUSCI_B interrupt vector value
        UCB3IV_SPI_UCIV: 0..15 = enum UCB3IV_SPI_UCIV {
            /// No interrupt pending
            NONE = 0b0000000000000000,
