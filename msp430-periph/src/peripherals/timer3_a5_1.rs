...
utils::periph! {
    ...
    rw TA3CCTL2 @ 0x06: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA3CCTL2_CCIFG: 0 = struct TA3CCTL2_CCIFG(bool);
        /// Capture/compare overflow flag
        TA3CCTL2_COV: 1 = struct TA3CCTL2_COV(bool);
        /// PWM Output signal if output mode 0
        TA3CCTL2_OUT: 2 = struct TA3CCTL2_OUT(bool);
        /// Capture input signal (read)
        TA3CCTL2_CCI: 3 = struct TA3CCTL2_CCI(bool);
        /// Capture/compare interrupt enable
        TA3CCTL2_CCIE: 4 = struct TA3CCTL2_CCIE(bool);
        /// Output mode 2
        ...
        /// Capture mode: 1 /Compare mode : 0
        TA3CCTL2_CAP: 8 = struct TA3CCTL2_CAP(bool);
        /// Latched capture signal (read)
        TA3CCTL2_SCCI: 10 = struct TA3CCTL2_SCCI(bool);
        /// Capture sychronize
        TA3CCTL2_SCS: 11 = struct TA3CCTL2_SCS(bool);
        /// Capture input select 1
    ...
    rw TA3CCTL3 @ 0x08: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA3CCTL3_CCIFG: 0 = struct TA3CCTL3_CCIFG(bool);
        /// Capture/compare overflow flag
        TA3CCTL3_COV: 1 = struct TA3CCTL3_COV(bool);
        /// PWM Output signal if output mode 0
        TA3CCTL3_OUT: 2 = struct TA3CCTL3_OUT(bool);
        /// Capture input signal (read)
        TA3CCTL3_CCI: 3 = struct TA3CCTL3_CCI(bool);
        /// Capture/compare interrupt enable
        TA3CCTL3_CCIE: 4 = struct TA3CCTL3_CCIE(bool);
        /// Output mode 2
        TA3CCTL3_OUTMOD: 5..7 = enum TA3CCTL3_OUTMOD {
            /// PWM output mode: 0 - output only
            OUTMOD_0 = 0b000,
            /// PWM output mode: 1 - set
            OUTMOD_1 = 0b001,
        ...
        /// Capture mode: 1 /Compare mode : 0
        TA3CCTL3_CAP: 8 = struct TA3CCTL3_CAP(bool);
        /// Latched capture signal (read)
        TA3CCTL3_SCCI: 10 = struct TA3CCTL3_SCCI(bool);
        /// Capture sychronize
        TA3CCTL3_SCS: 11 = struct TA3CCTL3_SCS(bool);
        /// Capture input select 1
        TA3CCTL3_CCIS: 12..13 = enum TA3CCTL3_CCIS {
            /// Capture input select: 0 - CCIxA
            CCIS_0 = 0b00,
            /// Capture input select: 1 - CCIxB
            CCIS_1 = 0b01,
        ...
        /// Capture mode 1
        TA3CCTL3_CM: 14..15 = enum TA3CCTL3_CM {
            /// Capture mode: 0 - disabled
            CM_0 = 0b00,
            /// Capture mode: 1 - pos. edge
            CM_1 = 0b01,
    ...
    rw TA3CCTL4 @ 0x0a: u16 = 0_0 {
        /// Capture/compare interrupt flag
        TA3CCTL4_CCIFG: 0 = struct TA3CCTL4_CCIFG(bool);
        /// Capture/compare overflow flag
        TA3CCTL4_COV: 1 = struct TA3CCTL4_COV(bool);
        /// PWM Output signal if output mode 0
        TA3CCTL4_OUT: 2 = struct TA3CCTL4_OUT(bool);
        /// Capture input signal (read)
        TA3CCTL4_CCI: 3 = struct TA3CCTL4_CCI(bool);
        /// Capture/compare interrupt enable
        TA3CCTL4_CCIE: 4 = struct TA3CCTL4_CCIE(bool);
        /// Output mode 2
        TA3CCTL4_OUTMOD: 5..7 = enum TA3CCTL4_OUTMOD {
            /// PWM output mode: 0 - output only
            OUTMOD_0 = 0b000,
            /// PWM output mode: 1 - set
            OUTMOD_1 = 0b001,
        ...
        /// Capture mode: 1 /Compare mode : 0
        TA3CCTL4_CAP: 8 = struct TA3CCTL4_CAP(bool);
        /// Latched capture signal (read)
        TA3CCTL4_SCCI: 10 = struct TA3CCTL4_SCCI(bool);
        /// Capture sychronize
        TA3CCTL4_SCS: 11 = struct TA3CCTL4_SCS(bool);
        /// Capture input select 1
        TA3CCTL4_CCIS: 12..13 = enum TA3CCTL4_CCIS {
            /// Capture input select: 0 - CCIxA
            CCIS_0 = 0b00,
            /// Capture input select: 1 - CCIxB
            CCIS_1 = 0b01,
        ...
        /// Capture mode 1
        TA3CCTL4_CM: 14..15 = enum TA3CCTL4_CM {
            /// Capture mode: 0 - disabled
            CM_0 = 0b00,
            /// Capture mode: 1 - pos. edge
            CM_1 = 0b01,
    ...
    rw TA3CCR3 @ 0x18: u16 = 0_0 {
        /// Timer3_A5 Capture/Compare 3
        TA3CCR3: 0..15 = struct TA3CCR3Field(u16);
    }
    /// Timer3_A5 Capture/Compare 4
    rw TA3CCR4 @ 0x1a: u16 = 0_0 {
        /// Timer3_A5 Capture/Compare 4
        TA3CCR4: 0..15 = struct TA3CCR4Field(u16);
    }
