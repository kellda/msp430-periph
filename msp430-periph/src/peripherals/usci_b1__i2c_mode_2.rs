...
utils::periph! {
    ...
    rw UCB1CTLW0 @ 0x00: u16 = 0_0 {
        /// USCI B1 Control Word Register 0
        UCB1CTLW0: 0..15 = struct UCB1CTLW0Field(u16);
    }
    ...
    rw UCB1RXBUF @ 0x0c: u8 = 0_0 {
        /// USCI B1 Receive Buffer
        UCB1RXBUF: 0..7 = struct UCB1RXBUFField(u8);
    }
    /// USCI B1 Transmit Buffer
    rw UCB1TXBUF @ 0x0e: u8 = 0_0 {
        /// USCI B1 Transmit Buffer
        UCB1TXBUF: 0..7 = struct UCB1TXBUFField(u8);
    }
    /// USCI B1 I2C Own Address
    rw UCB1I2COA @ 0x10: u16 = 0_0 {
        /// I2C Own Address 0
    ...
    rw UCB1ICTL @ 0x1c: u16 = 0_0 {
        /// USCI B1 Interrupt Enable Register
        UCB1ICTL: 0..15 = struct UCB1ICTLField(u16);
    }
    /// USCI B1 Interrupt Enable Register
    rw UCB1IE @ 0x1c: u8 = 0_0 {
