...
utils::periph! {
    ...
    rw DMACTL0 @ 0x00: u16 = 0_0 {
        ...
        DMA1TSEL: 4..7 = enum DMA1TSEL {
            ...
            DMA1TSEL_2 = 0b0010,
            /// DMA channel 1 transfer select 3:  UART0/I2C receive
            DMA1TSEL_3 = 0b0011,
            /// DMA channel 1 transfer select 4:  UART0/I2C transmit
            DMA1TSEL_4 = 0b0100,
        ...
        DMA2TSEL: 8..11 = enum DMA2TSEL {
            ...
            DMA2TSEL_2 = 0b0010,
            /// DMA channel 2 transfer select 3:  UART0/I2C receive
            DMA2TSEL_3 = 0b0011,
            /// DMA channel 2 transfer select 4:  UART0/I2C transmit
            DMA2TSEL_4 = 0b0100,
    ...
    rw DMA1SA @ 0xc8: u16 = 0_0 {
        /// DMA Channel 1 Source Address
        DMA1SA: 0..15 = struct DMA1SAField(u16);
    }
    /// DMA Channel 1 Destination Address
    rw DMA1DA @ 0xca: u16 = 0_0 {
        /// DMA Channel 1 Destination Address
        DMA1DA: 0..15 = struct DMA1DAField(u16);
    }
    /// DMA Channel 1 Transfer Size
    rw DMA1SZ @ 0xcc: u16 = 0_0 {
        /// DMA Channel 1 Transfer Size
        DMA1SZ: 0..15 = struct DMA1SZField(u16);
    }
    /// DMA Channel 2 Source Address
    rw DMA2SA @ 0xd0: u16 = 0_0 {
        /// DMA Channel 2 Source Address
        DMA2SA: 0..15 = struct DMA2SAField(u16);
    }
    /// DMA Channel 2 Destination Address
    rw DMA2DA @ 0xd2: u16 = 0_0 {
        /// DMA Channel 2 Destination Address
        DMA2DA: 0..15 = struct DMA2DAField(u16);
    }
    /// DMA Channel 2 Transfer Size
    rw DMA2SZ @ 0xd4: u16 = 0_0 {
        /// DMA Channel 2 Transfer Size
