...
utils::periph! {
    ...
    rw PMMIFG @ 0x0a: u16 = 0_0 {
        ...
        PMMPORIFG: 10..10 = enum PMMPORIFG {
        ...
        /// LPMx.5 flag.
        PMMLPM5IFG: 15..15 = enum PMMLPM5IFG {
